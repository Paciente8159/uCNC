...
// step delay not used
	...
	float dof_a[AXIS_TO_STEPPERS];
	float dof_alpha[AXIS_TO_STEPPERS];
	float dof_d[AXIS_TO_STEPPERS];
	float dof_theta_offset[AXIS_TO_STEPPERS];
	float dof_joint_min[AXIS_TO_STEPPERS];
	float dof_joint_max[AXIS_TO_STEPPERS];
#endif
