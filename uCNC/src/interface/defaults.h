...
#if (!defined(DEFAULT_S_CURVE_PROFILE))
#define DEFAULT_S_CURVE_PROFILE 0
#endif
...
#if (!defined(DEFAULT_LASER_PPI_MIXED_PPI))
#define DEFAULT_LASER_PPI_MIXED_PPI 0.25
#endif

#if (!defined(DEFAULT_LASER_PPI_MIXED_USWIDTH))
#define DEFAULT_LASER_PPI_MIXED_USWIDTH 0.75
#endif

#if (!defined(DEFAULT_TOOL_LENGTH_OFFSET))
#define DEFAULT_TOOL_LENGTH_OFFSET DEFAULT_ARRAY(TOOL_COUNT, 0)
#endif

#if (!defined(DEFAULT_BACKLASH_COMPENSATION))
#define DEFAULT_BACKLASH_COMPENSATION DEFAULT_ARRAY(AXIS_TO_STEPPERS, 0)
#endif

#if (!defined(DEFAULT_SKEW_XY_FACTOR))
#define DEFAULT_SKEW_XY_FACTOR 0
#endif

#if (!defined(DEFAULT_SKEW_XZ_FACTOR))
#define DEFAULT_SKEW_XZ_FACTOR 0
#endif

#if (!defined(DEFAULT_SKEW_YZ_FACTOR))
#define DEFAULT_SKEW_YZ_FACTOR 0
#endif

#if (!defined(DEFAULT_ENCODERS_PULSE_INV_MASK))
#define DEFAULT_ENCODERS_PULSE_INV_MASK 0
#endif

#if (!defined(DEFAULT_ENCODERS_DIR_INV_MASK))
#define DEFAULT_ENCODERS_DIR_INV_MASK 0
#endif

#if (!defined(DEFAULT_ENCODERS_RESOLUTION))
#define DEFAULT_ENCODERS_RESOLUTION DEFAULT_ARRAY(ENCODERS, 1)
#endif
