...
#define protocol_send_feedback(__s)                                            \
...
#define protocol_send_cnc_settings_delegate_event_                             \
  proto_cnc_settings_delegate_event_
#define protocol_send_cnc_settings_delegate_event_t                            \
  proto_cnc_settings_delegate_event_t
...
#define protocol_send_pins_states_delegate_event_                              \
  proto_cnc_pins_states_delegate_event_
#define protocol_send_pins_states_delegate_event_t                             \
  proto_cnc_pins_states_delegate_event_t
...
#define protocol_send_gcode_modes_delegate_event_                              \
  proto_gcode_modes_delegate_event_
#define protocol_send_gcode_modes_delegate_event_t                             \
  proto_gcode_modes_delegate_event_t
