/*
        ...
        Description: Contains all MCU and PIN definitions for Arduino Nucleo
   F411 with CNC Shield V3 to run µCNC.
...
// #define STEP3_BIT 6	 // assigns STEP3 pin but must comment Spindle PWM and
// Dir #define STEP3_PORT A // assigns STEP3 port but must comment Spindle PWM
// and Dir
...
// If no servos are configured then the timer is free for other functions (like
// PWM) (even if defined in the board) On STM32F1x cores this will default to
// Timer 3 #define SERVO_TIMER 3
