/*
	...
	Description: Contains all MCU and PIN definitions for Arduino UNO R4 similar to Grbl 0.9+ to run µCNC.
...
#define STEP2_PORT 1 // assigns STEP2 port
#define STEP1_BIT 4	 // assigns STEP1 pin
#define STEP1_PORT 1 // assigns STEP1 port
#define STEP0_BIT 5	 // assigns STEP0 pin
#define STEP0_PORT 1 // assigns STEP0 port
...
#define DIR2_PORT 1 // assigns DIR2 port
#define DIR1_BIT 6	// assigns DIR1 pin
#define DIR1_PORT 1 // assigns DIR1 port
#define DIR0_BIT 2	// assigns DIR0 pin
#define DIR0_PORT 1 // assigns DIR0 port

// Setup limit pins
#define LIMIT_Z_BIT 10	 // assigns LIMIT_Z pin
...
#define LIMIT_X_BIT 3	 // assigns LIMIT_X pin
#define LIMIT_X_PORT 3 // assigns LIMIT_X port
...
#define PWM0_PORT 1 // assigns PWM0 pin
