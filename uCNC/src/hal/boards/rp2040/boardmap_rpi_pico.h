/*
                ...
                Description: Contains all MCU and PIN definitions for Raspberry
   Pi Pico W to run µCNC.
...
// // IO pins should be sequencial GPIO pins starting by data, then clock then
// the latch pin #define IC74HC595_CUSTOM_SHIFT_IO //Enables custom MCU data
// shift transmission. In RP2040 that is via a PIO #define IC74HC595_PIO_DATA 26
// #define IC74HC595_PIO_CLK 27
// #define IC74HC595_PIO_LATCH 28
// // enabling IC74HC595_CUSTOM_SHIFT_IO will force IC74HC595_COUNT to be set to
// 4 no matter what
// // support up to 4 chained 74HC595. Less can be used (overflow bits will be
// discarded like in the ESP32 I2S implementation) #define IC74HC595_COUNT 4
