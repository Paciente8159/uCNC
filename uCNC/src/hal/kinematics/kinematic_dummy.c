/*
                ...
                Description: Custom kinematics definitions for a dummy
   kinematics
...
uint8_t kinematics_home(void) { return STATUS_OK; }

bool kinematics_check_boundaries(float *axis) { return true; }
