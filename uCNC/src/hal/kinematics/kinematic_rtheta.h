...
#define KINEMATICS_VARS_DEFAULTS_INIT                                          \
  .rtheta_theta_homing_angle = RTHETA_HOME_ANGLE_DEFAULT,                      \
...
#define KINEMATICS_VARS_SETTINGS_INIT                                          \
  {.id = 28,                                                                   \
   .memptr = &g_settings.rtheta_theta_homing_angle,                            \
   .type = SETTING_TYPE_FLOAT},                                                \
      {.id = 29,                                                               \
       .memptr = &g_settings.rthera_arm_homing_distance,                       \
       .type = SETTING_TYPE_FLOAT},                                            \
      {.id = 106,                                                              \
       .memptr = &g_settings.rtheta_theta_reduction_ratio,                     \
       .type = SETTING_TYPE_FLOAT},                                            \
      {.id = 107,                                                              \
       .memptr = &g_settings.rtheta_arm_length,                                \
       .type = SETTING_TYPE_FLOAT},
...
#define KINEMATICS_VARS_SYSTEM_MENU_INIT                                       \
  DECL_MENU_VAR(SYSTEM_MENU_ID_HOMING, s28, STR_RTHETA_HOME_ANGLE,             \
                &g_settings.rtheta_theta_homing_angle, VAR_TYPE_FLOAT);        \
  DECL_MENU_VAR(SYSTEM_MENU_ID_HOMING, s29, STR_RTHETA_HOME_DIST,              \
                &g_settings.rthera_arm_homing_distance, VAR_TYPE_FLOAT);       \
  DECL_MENU_VAR(SYSTEM_MENU_ID_KINEMATIC_SETTINGS, s106, STR_RTHETA_RATIO,     \
                &g_settings.rtheta_theta_reduction_ratio, VAR_TYPE_FLOAT);     \
  DECL_MENU_VAR(SYSTEM_MENU_ID_KINEMATIC_SETTINGS, s107, STR_RTHETA_ARM_LEN,   \
                &g_settings.rtheta_arm_length, VAR_TYPE_FLOAT);
