...
/*PWM*/
#define pwm_tcc_config(timer, presc)        \
	do                                      \
	{                                       \
...
#define pwm_tc_config(timer, presc)                \
	do                                             \
	{                                              \
...
#define PWM0_CONFIG(presc) pwm_tcc_config(PWM0_TMR, presc)
#define PWM0_DUTYCYCLE (PWM0_TMR->CC[(PWM0_CHANNEL & 0x03)].bit.CC)
#else
#define PWM0_TMR __helper__(TC, PWM0_TIMER, )
#define PWM0_CONFIG(presc) pwm_tc_config(PWM0_TMR, presc)
#define PWM0_DUTYCYCLE (PWM0_TMR->COUNT8.CC[(PWM0_CHANNEL & 0x03)].reg)
#endif
...
#define PWM1_CONFIG(presc) pwm_tcc_config(PWM1_TMR, presc)
#define PWM1_DUTYCYCLE (PWM0_TMR->CC[(PWM1_CHANNEL & 0x03)].bit.CC)
#else
#define PWM1_TMR __helper__(TC, PWM1_TIMER, )
#define PWM1_CONFIG(presc) pwm_tc_config(PWM1_TMR, presc)
#define PWM1_DUTYCYCLE (PWM1_TMR->COUNT8.CC[(PWM1_CHANNEL & 0x03)].reg)
#endif
...
#define PWM2_CONFIG(presc) pwm_tcc_config(PWM2_TMR, presc)
#define PWM2_DUTYCYCLE (PWM0_TMR->CC[(PWM2_CHANNEL & 0x03)].bit.CC)
#else
#define PWM2_TMR __helper__(TC, PWM2_TIMER, )
#define PWM2_CONFIG(presc) pwm_tc_config(PWM2_TMR, presc)
#define PWM2_DUTYCYCLE (PWM2_TMR->COUNT8.CC[(PWM2_CHANNEL & 0x03)].reg)
#endif
...
#define PWM3_CONFIG(presc) pwm_tcc_config(PWM3_TMR, presc)
#define PWM3_DUTYCYCLE (PWM0_TMR->CC[(PWM3_CHANNEL & 0x03)].bit.CC)
#else
#define PWM3_TMR __helper__(TC, PWM3_TIMER, )
#define PWM3_CONFIG(presc) pwm_tc_config(PWM3_TMR, presc)
#define PWM3_DUTYCYCLE (PWM3_TMR->COUNT8.CC[(PWM3_CHANNEL & 0x03)].reg)
#endif
...
#define PWM4_CONFIG(presc) pwm_tcc_config(PWM4_TMR, presc)
#define PWM4_DUTYCYCLE (PWM0_TMR->CC[(PWM4_CHANNEL & 0x03)].bit.CC)
#else
#define PWM4_TMR __helper__(TC, PWM4_TIMER, )
#define PWM4_CONFIG(presc) pwm_tc_config(PWM4_TMR, presc)
#define PWM4_DUTYCYCLE (PWM4_TMR->COUNT8.CC[(PWM4_CHANNEL & 0x03)].reg)
#endif
...
#define PWM5_CONFIG(presc) pwm_tcc_config(PWM5_TMR, presc)
#define PWM5_DUTYCYCLE (PWM0_TMR->CC[(PWM5_CHANNEL & 0x03)].bit.CC)
#else
#define PWM5_TMR __helper__(TC, PWM5_TIMER, )
#define PWM5_CONFIG(presc) pwm_tc_config(PWM5_TMR, presc)
#define PWM5_DUTYCYCLE (PWM5_TMR->COUNT8.CC[(PWM5_CHANNEL & 0x03)].reg)
#endif
...
#define PWM6_CONFIG(presc) pwm_tcc_config(PWM6_TMR, presc)
#define PWM6_DUTYCYCLE (PWM0_TMR->CC[(PWM6_CHANNEL & 0x03)].bit.CC)
#else
#define PWM6_TMR __helper__(TC, PWM6_TIMER, )
#define PWM6_CONFIG(presc) pwm_tc_config(PWM6_TMR, presc)
#define PWM6_DUTYCYCLE (PWM6_TMR->COUNT8.CC[(PWM6_CHANNEL & 0x03)].reg)
#endif
...
#define PWM7_CONFIG(presc) pwm_tcc_config(PWM7_TMR, presc)
#define PWM7_DUTYCYCLE (PWM0_TMR->CC[(PWM7_CHANNEL & 0x03)].bit.CC)
#else
#define PWM7_TMR __helper__(TC, PWM7_TIMER, )
#define PWM7_CONFIG(presc) pwm_tc_config(PWM7_TMR, presc)
#define PWM7_DUTYCYCLE (PWM7_TMR->COUNT8.CC[(PWM7_CHANNEL & 0x03)].reg)
#endif
...
#define PWM8_CONFIG(presc) pwm_tcc_config(PWM8_TMR, presc)
#define PWM8_DUTYCYCLE (PWM0_TMR->CC[(PWM8_CHANNEL & 0x03)].bit.CC)
#else
#define PWM8_TMR __helper__(TC, PWM8_TIMER, )
#define PWM8_CONFIG(presc) pwm_tc_config(PWM8_TMR, presc)
#define PWM8_DUTYCYCLE (PWM8_TMR->COUNT8.CC[(PWM8_CHANNEL & 0x03)].reg)
#endif
...
#define PWM9_CONFIG(presc) pwm_tcc_config(PWM9_TMR, presc)
#define PWM9_DUTYCYCLE (PWM0_TMR->CC[(PWM9_CHANNEL & 0x03)].bit.CC)
#else
#define PWM9_TMR __helper__(TC, PWM9_TIMER, )
#define PWM9_CONFIG(presc) pwm_tc_config(PWM9_TMR, presc)
#define PWM9_DUTYCYCLE (PWM9_TMR->COUNT8.CC[(PWM9_CHANNEL & 0x03)].reg)
#endif
...
#define PWM10_CONFIG(presc) pwm_tcc_config(PWM10_TMR, presc)
#define PWM10_DUTYCYCLE (PWM0_TMR->CC[(PWM10_CHANNEL & 0x03)].bit.CC)
#else
#define PWM10_TMR __helper__(TC, PWM10_TIMER, )
#define PWM10_CONFIG(presc) pwm_tc_config(PWM10_TMR, presc)
#define PWM10_DUTYCYCLE (PWM10_TMR->COUNT8.CC[(PWM10_CHANNEL & 0x03)].reg)
#endif
...
#define PWM11_CONFIG(presc) pwm_tcc_config(PWM11_TMR, presc)
#define PWM11_DUTYCYCLE (PWM0_TMR->CC[(PWM11_CHANNEL & 0x03)].bit.CC)
#else
#define PWM11_TMR __helper__(TC, PWM11_TIMER, )
#define PWM11_CONFIG(presc) pwm_tc_config(PWM11_TMR, presc)
#define PWM11_DUTYCYCLE (PWM11_TMR->COUNT8.CC[(PWM11_CHANNEL & 0x03)].reg)
#endif
...
#define PWM12_CONFIG(presc) pwm_tcc_config(PWM12_TMR, presc)
#define PWM12_DUTYCYCLE (PWM0_TMR->CC[(PWM12_CHANNEL & 0x03)].bit.CC)
#else
#define PWM12_TMR __helper__(TC, PWM12_TIMER, )
#define PWM12_CONFIG(presc) pwm_tc_config(PWM12_TMR, presc)
#define PWM12_DUTYCYCLE (PWM12_TMR->COUNT8.CC[(PWM12_CHANNEL & 0x03)].reg)
#endif
...
#define PWM13_CONFIG(presc) pwm_tcc_config(PWM13_TMR, presc)
#define PWM13_DUTYCYCLE (PWM0_TMR->CC[(PWM13_CHANNEL & 0x03)].bit.CC)
#else
#define PWM13_TMR __helper__(TC, PWM13_TIMER, )
#define PWM13_CONFIG(presc) pwm_tc_config(PWM13_TMR, presc)
#define PWM13_DUTYCYCLE (PWM13_TMR->COUNT8.CC[(PWM13_CHANNEL & 0x03)].reg)
#endif
...
#define PWM14_CONFIG(presc) pwm_tcc_config(PWM14_TMR, presc)
#define PWM14_DUTYCYCLE (PWM0_TMR->CC[(PWM14_CHANNEL & 0x03)].bit.CC)
#else
#define PWM14_TMR __helper__(TC, PWM14_TIMER, )
#define PWM14_CONFIG(presc) pwm_tc_config(PWM14_TMR, presc)
#define PWM14_DUTYCYCLE (PWM14_TMR->COUNT8.CC[(PWM14_CHANNEL & 0x03)].reg)
#endif
...
#define PWM15_CONFIG(presc) pwm_tcc_config(PWM15_TMR, presc)
#define PWM15_DUTYCYCLE (PWM0_TMR->CC[(PWM15_CHANNEL & 0x03)].bit.CC)
#else
#define PWM15_TMR __helper__(TC, PWM15_TIMER, )
#define PWM15_CONFIG(presc) pwm_tc_config(PWM15_TMR, presc)
#define PWM15_DUTYCYCLE (PWM15_TMR->COUNT8.CC[(PWM15_CHANNEL & 0x03)].reg)
#endif
