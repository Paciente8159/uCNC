...
uint8_t mcu_spi_xmit(uint8_t data) { return esp32spi->transfer(data); }
...
void mcu_spi_stop(void) { esp32spi->endTransaction(); }
...
uint8_t mcu_spi2_xmit(uint8_t data) { return esp32spi2->transfer(data); }
...
void mcu_spi2_stop(void) { esp32spi2->endTransaction(); }
