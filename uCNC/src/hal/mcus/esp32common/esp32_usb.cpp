...
static void usbEventCallback(void *arg, esp_event_base_t event_base,
  ...
  if (event_base == ARDUINO_USB_EVENTS) {
    ...
    // arduino_usb_cdc_event_data_t *data = (arduino_usb_cdc_event_data_t
    // *)event_data;
    switch (event_id) {
    ...
    case ARDUINO_USB_CDC_LINE_CODING_EVENT:
      // Serial.printf(
      // 		"CDC LINE CODING: bit_rate: %lu, data_bits: %u,
      // stop_bits: %u, parity: %u\n", data->line_coding.bit_rate,
      // data->line_coding.data_bits, 		data->line_coding.stop_bits,
