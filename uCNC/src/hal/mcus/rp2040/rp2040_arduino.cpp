/*
        ...
        Description: Contains all Arduino RP2040 C++ to C functions ports needed
   by µCNC.
...
#include <EEPROM.h>
extern "C" {
void rp2040_eeprom_init(int size) { EEPROM.begin(size); }

uint8_t rp2040_eeprom_read(uint16_t address) { return EEPROM.read(address); }
