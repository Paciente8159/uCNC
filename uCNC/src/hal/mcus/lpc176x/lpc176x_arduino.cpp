...
void lpc176x_usb_dotasks(void) { MSC_RunDeferredCommands(); }

bool lpc176x_usb_available(void) { return (UsbSerial.available() > 0); }

uint8_t lpc176x_usb_getc(void) { return (uint8_t)UsbSerial.read(); }
