...
#if (COM_PORT==1) && (COM_TX_PIN==STM32IO_B8) && (COM_RX_PIN==STM32IO_B7)
#define COM_APB APB2ENR
#define COM_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART 8
#elif (COM_PORT==1) && (COM_TX_PIN==STM32IO_B14) && (COM_RX_PIN==STM32IO_B15)
#define COM_APB APB2ENR
#define COM_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART 4
#elif (COM_PORT==1) && (COM_TX_PIN==STM32IO_A9) && (COM_RX_PIN==STM32IO_A10)
#define COM_APB APB2ENR
#define COM_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART 7
#elif (COM_PORT==2) && (COM_TX_PIN==STM32IO_D5) && (COM_RX_PIN==STM32IO_D6)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART2EN
#define GPIO_AF_USART 7
#elif (COM_PORT==2) && (COM_TX_PIN==STM32IO_A2) && (COM_RX_PIN==STM32IO_A3)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART2EN
#define GPIO_AF_USART 7
#elif (COM_PORT==3) && (COM_TX_PIN==STM32IO_B10) && (COM_RX_PIN==STM32IO_B11)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART3EN
#define GPIO_AF_USART 7
#elif (COM_PORT==3) && (COM_TX_PIN==STM32IO_C10) && (COM_RX_PIN==STM32IO_C11)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART3EN
#define GPIO_AF_USART 7
#elif (COM_PORT==4) && (COM_TX_PIN==STM32IO_A0) && (COM_RX_PIN==STM32IO_A1)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART 8
#elif (COM_PORT==4) && (COM_TX_PIN==STM32IO_A12) && (COM_RX_PIN==STM32IO_A11)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART 7
#elif (COM_PORT==4) && (COM_TX_PIN==STM32IO_C10) && (COM_RX_PIN==STM32IO_C11)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART 8
#elif (COM_PORT==4) && (COM_TX_PIN==STM32IO_D1) && (COM_RX_PIN==STM32IO_D0)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART 8
#elif (COM_PORT==5) && (COM_TX_PIN==STM32IO_B6) && (COM_RX_PIN==STM32IO_B5)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART 14
#elif (COM_PORT==5) && (COM_TX_PIN==STM32IO_B13) && (COM_RX_PIN==STM32IO_B12)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART 14
#elif (COM_PORT==5) && (COM_TX_PIN==STM32IO_C12) && (COM_RX_PIN==STM32IO_D2)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART 8
#elif (COM_PORT==6) && (COM_TX_PIN==STM32IO_C6) && (COM_RX_PIN==STM32IO_C7)
#define COM_APB APB2ENR
#define COM_APBEN RCC_APB2ENR_USART6EN
#define GPIO_AF_USART 7
#elif (COM_PORT==6) && (COM_TX_PIN==STM32IO_G14) && (COM_RX_PIN==STM32IO_G9)
#define COM_APB APB2ENR
#define COM_APBEN RCC_APB2ENR_USART6EN
#define GPIO_AF_USART 7
#elif (COM_PORT==7) && (COM_TX_PIN==STM32IO_A15) && (COM_RX_PIN==STM32IO_A8)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART 11
#elif (COM_PORT==7) && (COM_TX_PIN==STM32IO_B4) && (COM_RX_PIN==STM32IO_B3)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART 11
#elif (COM_PORT==7) && (COM_TX_PIN==STM32IO_E8) && (COM_RX_PIN==STM32IO_E7)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART 7
#elif (COM_PORT==7) && (COM_TX_PIN==STM32IO_F7) && (COM_RX_PIN==STM32IO_F6)
#define COM_APB APB1LENR
#define COM_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART 7
#elif (COM_PORT==8) && (COM_TX_PIN==STM32IO_E1) && (COM_RX_PIN==STM32IO_E0)
#define COM_APB APB1LENR
...
#if (COM2_PORT==1) && (COM2_TX_PIN==STM32IO_B8) && (COM2_RX_PIN==STM32IO_B7)
#define COM2_APB APB2ENR
#define COM2_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART2 8
#elif (COM2_PORT==1) && (COM2_TX_PIN==STM32IO_B14) && (COM2_RX_PIN==STM32IO_B15)
#define COM2_APB APB2ENR
#define COM2_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART2 4
#elif (COM2_PORT==1) && (COM2_TX_PIN==STM32IO_A9) && (COM2_RX_PIN==STM32IO_A10)
#define COM2_APB APB2ENR
#define COM2_APBEN RCC_APB2ENR_USART1EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==2) && (COM2_TX_PIN==STM32IO_D5) && (COM2_RX_PIN==STM32IO_D6)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART2EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==2) && (COM2_TX_PIN==STM32IO_A2) && (COM2_RX_PIN==STM32IO_A3)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART2EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==3) && (COM2_TX_PIN==STM32IO_B10) && (COM2_RX_PIN==STM32IO_B11)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART3EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==3) && (COM2_TX_PIN==STM32IO_C10) && (COM2_RX_PIN==STM32IO_C11)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART3EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==4) && (COM2_TX_PIN==STM32IO_A0) && (COM2_RX_PIN==STM32IO_A1)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART2 8
#elif (COM2_PORT==4) && (COM2_TX_PIN==STM32IO_A12) && (COM2_RX_PIN==STM32IO_A11)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==4) && (COM2_TX_PIN==STM32IO_C10) && (COM2_RX_PIN==STM32IO_C11)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART2 8
#elif (COM2_PORT==4) && (COM2_TX_PIN==STM32IO_D1) && (COM2_RX_PIN==STM32IO_D0)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART4EN
#define GPIO_AF_USART2 8
#elif (COM2_PORT==5) && (COM2_TX_PIN==STM32IO_B6) && (COM2_RX_PIN==STM32IO_B5)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART2 14
#elif (COM2_PORT==5) && (COM2_TX_PIN==STM32IO_B13) && (COM2_RX_PIN==STM32IO_B12)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART2 14
#elif (COM2_PORT==5) && (COM2_TX_PIN==STM32IO_C12) && (COM2_RX_PIN==STM32IO_D2)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART5EN
#define GPIO_AF_USART2 8
#elif (COM2_PORT==6) && (COM2_TX_PIN==STM32IO_C6) && (COM2_RX_PIN==STM32IO_C7)
#define COM2_APB APB2ENR
#define COM2_APBEN RCC_APB2ENR_USART6EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==6) && (COM2_TX_PIN==STM32IO_G14) && (COM2_RX_PIN==STM32IO_G9)
#define COM2_APB APB2ENR
#define COM2_APBEN RCC_APB2ENR_USART6EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==7) && (COM2_TX_PIN==STM32IO_A15) && (COM2_RX_PIN==STM32IO_A8)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART2 11
#elif (COM2_PORT==7) && (COM2_TX_PIN==STM32IO_B4) && (COM2_RX_PIN==STM32IO_B3)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART2 11
#elif (COM2_PORT==7) && (COM2_TX_PIN==STM32IO_E8) && (COM2_RX_PIN==STM32IO_E7)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==7) && (COM2_TX_PIN==STM32IO_F7) && (COM2_RX_PIN==STM32IO_F6)
#define COM2_APB APB1LENR
#define COM2_APBEN RCC_APB1LENR_USART7EN
#define GPIO_AF_USART2 7
#elif (COM2_PORT==8) && (COM2_TX_PIN==STM32IO_E1) && (COM2_RX_PIN==STM32IO_E0)
#define COM2_APB APB1LENR
