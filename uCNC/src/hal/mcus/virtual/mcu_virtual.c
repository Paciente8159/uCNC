...
void mcu_init(void)
{
	...
	socket0.io.rx.rxHandler = mcu_wifi_rx_cb;
	socket0.io.isclient = true;
	strcpy(socket0.io.portname,"34000");
	socket_init(&socket0);
	send_char = false;
