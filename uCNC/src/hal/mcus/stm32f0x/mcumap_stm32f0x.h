/*
        ...
        Description: Contains all MCU and PIN definitions for STM32F0x to run
   µCNC.
...
#define SPI2_DMA_TX_CHANNEL __helper__(DMA1_Channel, SPI2_DMA_TX_CHANNEL_NUM, )
#define SPI2_DMA_RX_CHANNEL __helper__(DMA1_Channel, SPI2_DMA_RX_CHANNEL_NUM, )
...
#define mcu_config_output(diopin)                                              \
  {                                                                            \
    ...
    __indirect__(diopin, GPIO)->OSPEEDR |=                                     \
        (0x03 << ((__indirect__(diopin, BIT)) << 1)); /*fast speed mode*/      \
  }
