...
#define SPI_DMA_TX_IFCR SPI_DMA_CONTROLLER->LISR
#else
#define SPI_DMA_TX_IFCR SPI_DMA_CONTROLLER->HIFCR
#define SPI_DMA_TX_IFCR SPI_DMA_CONTROLLER->HISR
#endif
...
#define SPI_DMA_RX_IFCR SPI_DMA_CONTROLLER->LISR
#else
#define SPI_DMA_RX_IFCR SPI_DMA_CONTROLLER->HIFCR
#define SPI_DMA_RX_IFCR SPI_DMA_CONTROLLER->HISR
#endif

#define SPI_DMA_TX_IFCR_MASK (0b111101 << SPI_DMA_TX_IFR_POS)
#define SPI_DMA_RX_IFCR_MASK (0b111101 << SPI_DMA_RX_IFR_POS)

#define SPI_DMA_TX_IRQ __helper__(__helper__(DMA, SPI_DMA_CONTROLLER_NUM, _Stream), SPI_DMA_TX_STREAM_NUM, _IRQHandler)
#define SPI_DMA_RX_IRQ __helper__(__helper__(DMA, SPI_DMA_CONTROLLER_NUM, _Stream), SPI_DMA_RX_STREAM_NUM, _IRQHandler)
