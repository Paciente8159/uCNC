...
// #include "mem.h"
// #define EVENT_SCAN_DONE 9
// #include "lwip/dhcp.h"
// #include "lwip/dns.h"
// #include "lwip/inet.h"

// #undef os_printf
// #define os_printf proto_printf
...
// static scan_result_t g_scan_results[20];
...
// 	// Block until scan completes (Arduino-style)
// 	while (!g_scan_done)
// 	{
// 		os_delay_us(100000);
// 		mcu_dotasks();
...
// 		os_printf("Client disconnected from AP\n");
// 		break;
