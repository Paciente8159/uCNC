/*
        Name: esp8266_signal.c
        Description: Signal generation functions. Calculates several signals in
   a time based way.
...
MCU_CALLBACK void mcu_gen_step(void) {
  ...
  // ESP_LOGV("signal","step %d", signal_timer.step_alarm_en);
  // generate steps
  if (signal_timer.step_alarm_en) {
    ...
    if (t < 0) {
      // ESP_LOGV("signal","do step %d", reset);
      if (!reset) {
        mcu_step_cb();
      } else {
        mcu_step_reset_cb();
...
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM0)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM0)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM1)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM1)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM2)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM2)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM3)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM3)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM4)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM4)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM5)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM5)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM6)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM6)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM7)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM7)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM8)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM8)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM9)) ||             \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM9)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM10)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM10)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM11)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM11)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM12)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM12)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM13)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM13)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM14)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM14)))
...
#endif
#if ((defined(IC74HC595_HAS_PWMS) && ASSERT_PIN_EXTENDED(PWM15)) ||            \
     (defined(MCU_HAS_SOFT_PWM_TIMER) && ASSERT_PIN(PWM15)))
