...
#define UCSRB_2 __ucsrbreg__(UART2_PORT)
#define UCSRA_2 __ucsrareg__(UART2_PORT)
#define UDRIE_2 __udriereg__(UART2_PORT)
#define U2X_2 __u2xreg__(UART2_PORT)
#define UBRRH_2 __ubrrhreg__(UART2_PORT)
#define UBRRL_2 __ubrrlreg__(UART2_PORT)
#define RXEN_2 __rxenreg__(UART2_PORT)
#define TXEN_2 __txenreg__(UART2_PORT)
#define RXCIE_2 __rxciereg__(UART2_PORT)
#define UDRE_2 __udrereg__(UART2_PORT)
#define RXC_2 __rxcreg__(UART2_PORT)
#endif
