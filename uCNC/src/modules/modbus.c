...
void send_request(modbus_request_t request, uint8_t len,
...
bool read_response(modbus_response_t *response, uint8_t len,
                   softuart_port_t *port, uint32_t ms_timeout) {
  int16_t c = 0;
