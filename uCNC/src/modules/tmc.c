...
TMC_STEPPER_DECL(STEPPER1_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER1_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER2_HAS_TMC
TMC_STEPPER_DECL(STEPPER2_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER2_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER3_HAS_TMC
TMC_STEPPER_DECL(STEPPER3_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER3_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER4_HAS_TMC
TMC_STEPPER_DECL(STEPPER4_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER4_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER5_HAS_TMC
TMC_STEPPER_DECL(STEPPER5_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER5_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER6_HAS_TMC
TMC_STEPPER_DECL(STEPPER6_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER6_TMC_INTERFACE, 0);
#endif
#ifdef STEPPER7_HAS_TMC
TMC_STEPPER_DECL(STEPPER7_TMC_INTERFACE, 0);
TMC_STEPPER_RW(STEPPER7_TMC_INTERFACE, 0);
#endif
