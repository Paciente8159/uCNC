...
#include "../../../cnc.h"
#include "../../softspi.h"
	extern softspi_port_t w5500_spi;
...
#define W5500_SPI_INIT() softspi_config(&w5500_spi, {0}, 14000000)
#define W5500_SPI_START() softspi_start(&w5500_spi)
#define W5500_SPI_STOP() softspi_stop(&w5500_spi)
#define W5500_SPI_XMIT(c) softspi_xmit(&w5500_spi, c)
#define W5500_SPI_SEND(out, in, len) softspi_bulk_xmit(&w5500_spi, out, in, len)
#define W5500_SPI_TRANSFER(buf, len) softspi_bulk_xmit(&w5500_spi, buf, buf, len)
#define W5500_CS_SEL() io_clear_output(W5500_SPI_CS)
#define W5500_CS_DESEL() io_set_output(W5500_SPI_CS)
}
