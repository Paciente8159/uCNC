/*
        ...
        Description: This module adds the ability to control the
   IC74HC595(outputs) and IC74HC165(inputs) shift register controllers (used for
   example in the MKS-DLC32 board) to µCNC.
