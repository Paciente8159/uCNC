...
#define ENC7_VIRTUAL_INDEX_ONLY 0
     ...
     (ENCODERS > 1 && ENC1_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 2 && ENC2_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 3 && ENC3_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 4 && ENC4_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 5 && ENC5_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 6 && ENC6_VIRTUAL_INDEX) ||                                   \
     (ENCODERS > 7 && ENC7_VIRTUAL_INDEX))
...
#ifndef ENC0_READ
extern int32_t
enc_custom_read_enc0(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC1_READ
extern int32_t
enc_custom_read_enc1(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC2_READ
extern int32_t
enc_custom_read_enc2(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC3_READ
extern int32_t
enc_custom_read_enc3(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC4_READ
extern int32_t
enc_custom_read_enc4(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC5_READ
extern int32_t
enc_custom_read_enc5(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC6_READ
extern int32_t
enc_custom_read_enc6(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#ifndef ENC7_READ
extern int32_t
enc_custom_read_enc7(void); // custom encoder read callback will be defined in
                            // by a user/custom module
...
#define ENCODERS_IO_MASK                                                       \
  (ENC0_IO_MASK | ENC1_IO_MASK | ENC2_IO_MASK | ENC3_IO_MASK | ENC4_IO_MASK |  \
   ENC5_IO_MASK | ENC6_IO_MASK | ENC7_IO_MASK)

#if ((ENC0_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC0_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC0_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC0_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC0_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC0_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC0_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC0_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC0_INDEX_IO_MASK (1 << (ENC0_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC1_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC1_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC1_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC1_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC1_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC1_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC1_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC1_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC1_INDEX_IO_MASK (1 << (ENC1_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC2_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC2_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC2_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC2_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC2_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC2_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC2_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC2_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC2_INDEX_IO_MASK (1 << (ENC2_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC3_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC3_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC3_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC3_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC3_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC3_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC3_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC3_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC3_INDEX_IO_MASK (1 << (ENC3_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC4_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC4_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC4_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC4_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC4_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC4_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC4_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC4_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC4_INDEX_IO_MASK (1 << (ENC4_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC5_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC5_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC5_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC5_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC5_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC5_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC5_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC5_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC5_INDEX_IO_MASK (1 << (ENC5_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC6_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC6_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC6_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC6_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC6_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC6_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC6_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC6_INDEX == DIN7 && defined(DIN7_ISR)))
#define ENC6_INDEX_IO_MASK (1 << (ENC6_INDEX - DIN_PINS_OFFSET))
#endif
#if ((ENC7_INDEX == DIN0 && defined(DIN0_ISR)) ||                              \
     (ENC7_INDEX == DIN1 && defined(DIN1_ISR)) ||                              \
     (ENC7_INDEX == DIN2 && defined(DIN2_ISR)) ||                              \
     (ENC7_INDEX == DIN3 && defined(DIN3_ISR)) ||                              \
     (ENC7_INDEX == DIN4 && defined(DIN4_ISR)) ||                              \
     (ENC7_INDEX == DIN5 && defined(DIN5_ISR)) ||                              \
     (ENC7_INDEX == DIN6 && defined(DIN6_ISR)) ||                              \
     (ENC7_INDEX == DIN7 && defined(DIN7_ISR)))
...
#define ENCODERS_INDEX_IO_MASK                                                 \
  (ENC0_INDEX_IO_MASK | ENC1_INDEX_IO_MASK | ENC2_INDEX_IO_MASK |              \
   ENC3_INDEX_IO_MASK | ENC4_INDEX_IO_MASK | ENC5_INDEX_IO_MASK |              \
   ENC6_INDEX_IO_MASK | ENC7_INDEX_IO_MASK)
...
static void encoder_set_position_from_current_read(uint8_t i,
                                                   int32_t position) {
...
static void encoder_set_position_from_current_read_once(uint8_t i,
                                                        int32_t position) {
...
static FORCEINLINE int32_t encoder_floor_div_i32(int32_t value,
                                                 int32_t divisor) {
...
static void encoder_accept_virtual_index(uint8_t i, int32_t boundary) {
  ...
  avg10 =
      (s->count)
          ? (uint32_t)(((uint64_t)s->abs_delta_sum * 10ULL + (s->count / 2U)) /
                       s->count)
          : 0;
  str_snprintf(s->debug_line, sizeof(s->debug_line),
               "ENCIDX EC:%ld ECB:%ld LAST:%ld AVG:%lu.%lu MIN:%ld MAX:%ld "
               "N:%lu IGN:%lu",
               (long)encoder_get_position(i),
               (long)(encoder_get_position(i) - s->last_position),
               (long)s->last_delta, (unsigned long)(avg10 / 10U),
               (unsigned long)(avg10 % 10U), (long)s->min_delta,
               (long)s->max_delta, (unsigned long)s->count,
...
void encoder_virtual_index_update(uint8_t i) {
  ...
  if (!slot_delta ||
      (ABS(now - (s->origin + slot * (int32_t)cpr)) < hysteresis)) {
    return;
  }
...
bool encoder_get_index_stats(uint8_t i, int32_t *last, int32_t *min,
                             int32_t *max, uint32_t *count) {
  encoder_index_state_t *s;
...
bool encoder_get_index_debug_line(uint8_t i, char *line, uint32_t line_len,
                                  uint32_t *seq) {
...
#define ENC0_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC0,                            \
                                              ENC0_INDEX_RESET_POSITION);      \
...
#define ENC1_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC1,                            \
                                              ENC1_INDEX_RESET_POSITION);      \
...
#define ENC2_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC2,                            \
                                              ENC2_INDEX_RESET_POSITION);      \
...
#define ENC3_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC3,                            \
                                              ENC3_INDEX_RESET_POSITION);      \
...
#define ENC4_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC4,                            \
                                              ENC4_INDEX_RESET_POSITION);      \
...
#define ENC5_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC5,                            \
                                              ENC5_INDEX_RESET_POSITION);      \
...
#define ENC6_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC6,                            \
                                              ENC6_INDEX_RESET_POSITION);      \
...
#define ENC7_INDEX_EVENT()                                                     \
  encoder_set_position_from_current_read_once(ENC7,                            \
                                              ENC7_INDEX_RESET_POSITION);      \
...
void encoder_virtual_index_clear(uint8_t i) { (void)i; }

void encoder_virtual_index_update(uint8_t i) { (void)i; }
...
#if ((ENC0_PULSE != ENC0_DIR) || (ENC1_PULSE != ENC1_DIR) ||                   \
     (ENC2_PULSE != ENC2_DIR) || (ENC3_PULSE != ENC3_DIR) ||                   \
     (ENC4_PULSE != ENC4_DIR) || (ENC5_PULSE != ENC5_DIR) ||                   \
     (ENC6_PULSE != ENC6_DIR) || (ENC7_PULSE != ENC7_DIR))
...
#endif
    ENC0_PULSE_EVENT();
#if (defined(ENC0_INDEX) && !ENC0_VIRTUAL_INDEX_ONLY &&                        \
     (ENC0_INDEX_IO_MASK == 0))
...
#endif
    ENC1_PULSE_EVENT();
#if (defined(ENC1_INDEX) && !ENC1_VIRTUAL_INDEX_ONLY &&                        \
     (ENC1_INDEX_IO_MASK == 0))
...
#endif
    ENC2_PULSE_EVENT();
#if (defined(ENC2_INDEX) && !ENC2_VIRTUAL_INDEX_ONLY &&                        \
     (ENC2_INDEX_IO_MASK == 0))
...
#endif
    ENC3_PULSE_EVENT();
#if (defined(ENC3_INDEX) && !ENC3_VIRTUAL_INDEX_ONLY &&                        \
     (ENC3_INDEX_IO_MASK == 0))
...
#endif
    ENC4_PULSE_EVENT();
#if (defined(ENC4_INDEX) && !ENC4_VIRTUAL_INDEX_ONLY &&                        \
     (ENC4_INDEX_IO_MASK == 0))
...
#endif
    ENC5_PULSE_EVENT();
#if (defined(ENC5_INDEX) && !ENC5_VIRTUAL_INDEX_ONLY &&                        \
     (ENC5_INDEX_IO_MASK == 0))
...
#endif
    ENC6_PULSE_EVENT();
#if (defined(ENC6_INDEX) && !ENC6_VIRTUAL_INDEX_ONLY &&                        \
     (ENC6_INDEX_IO_MASK == 0))
...
#endif
    ENC7_PULSE_EVENT();
#if (defined(ENC7_INDEX) && !ENC7_VIRTUAL_INDEX_ONLY &&                        \
     (ENC7_INDEX_IO_MASK == 0))
...
static void encoder_update(uint8_t i) {
  ...
  if (incremental) {
    diff = (!(g_settings.encoders_dir_invert_mask & (1 << i)))
               ? (encoder_read - encoder_last_read[i])
               : (encoder_last_read[i] - encoder_read);
    encoder_last_read[i] = encoder_read;
...
int32_t encoder_get_position(uint8_t i) {
  ATOMIC_CODEBLOCK { return encoders_pos[i]; }

  return 0;
}

void encoder_print_values(void) {
  proto_printf("[EC:%ld RPM:%u]" MSG_FEEDBACK_END,
               (long)encoder_get_position(ENC0), encoder_get_rpm(ENC0));
}
...
#else
#warning                                                                       \
    "ENABLE_MAIN_LOOP_MODULES is not defined. Custom encoders may not get updated."
#endif
#endif
