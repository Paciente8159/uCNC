...
#define DOUTS_MASK (DOUTS_R0_MASK | DOUTS_R1_MASK)
...
#endif
#ifdef DIN8
#define DIN8_MASK BITMASKHIGH(DIN8)
#else
#define DIN8_MASK 0
#endif
#ifdef DIN9
#define DIN9_MASK BITMASKHIGH(DIN9)
#else
#define DIN9_MASK 0
#endif
#ifdef DIN10
#define DIN10_MASK BITMASKHIGH(DIN10)
#else
#define DIN10_MASK 0
#endif
#ifdef DIN11
#define DIN11_MASK BITMASKHIGH(DIN11)
#else
#define DIN11_MASK 0
#endif
#ifdef DIN12
#define DIN12_MASK BITMASKHIGH(DIN12)
#else
#define DIN12_MASK 0
#endif
#ifdef DIN13
#define DIN13_MASK BITMASKHIGH(DIN13)
#else
#define DIN13_MASK 0
#endif
#ifdef DIN14
#define DIN14_MASK BITMASKHIGH(DIN14)
#else
#define DIN14_MASK 0
#endif
#ifdef DIN15
#define DIN15_MASK BITMASKHIGH(DIN15)
#else
#define DIN15_MASK 0
#endif
...
#define DINS_MASK (DINS_R0 | DINS_R1)
