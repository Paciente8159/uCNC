...
#define CONTROLS_MASK (ESTOP_MASK | FHOLD_MASK | CS_RES_MASK)
...
#ifdef ESTOP_PULLUP
#define ESTOP_PULLUP_MASK BITMASK(ESTOP_PULLUP)
#else
#define ESTOP_PULLUP_MASK 0
#endif
#ifdef FHOLD_PULLUP
#define FHOLD_PULLUP_MASK BITMASK(FHOLD_PULLUP)
#else
#define FHOLD_PULLUP_MASK 0
#endif
#ifdef PROBE_PULLUP
#define PROBE_PULLUP_MASK BITMASK(PROBE_PULLUP)
#else
#define PROBE_PULLUP_MASK 0
#endif
#ifdef LIMIT_X_PULLUP
#define LIMIT_X_PULLUP_MASK BITMASK(LIMIT_X_PULLUP)
#else
#define LIMIT_X_PULLUP_MASK 0
#endif
#ifdef LIMIT_Y_PULLUP
#define LIMIT_Y_PULLUP_MASK BITMASK(LIMIT_Y_PULLUP)
#else
#define LIMIT_Y_PULLUP_MASK 0
#endif
#ifdef LIMIT_Z_PULLUP
#define LIMIT_Z_PULLUP_MASK BITMASK(LIMIT_Z_PULLUP)
#else
#define LIMIT_Z_PULLUP_MASK 0
#endif
#ifdef LIMIT_A_PULLUP
#define LIMIT_A_PULLUP_MASK BITMASK(LIMIT_A_PULLUP)
#else
#define LIMIT_A_PULLUP_MASK 0
#endif
#ifdef LIMIT_B_PULLUP
#define LIMIT_B_PULLUP_MASK BITMASK(LIMIT_B_PULLUP)
#else
#define LIMIT_B_PULLUP_MASK 0
#endif
#ifdef LIMIT_C_PULLUP
#define LIMIT_C_PULLUP_MASK BITMASK(LIMIT_C_PULLUP)
#else
...
#define CONTROLS_PULLUP_MASK (ESTOP_PULLUP_MASK | FHOLD_PULLUP_MASK | CS_RES_PULLUP_MASK)
