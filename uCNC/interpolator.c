...
void itp_run(void)
{
    ...
    while (!itp_sgm_is_full())
    {
        ...
        else if (itp_needs_update) //forces recalculation of acceleration and deacceleration profiles
        {
            ...
            {
                float accel_dist = ABS(junction_speed_sqr - itp_cur_plan_block->entry_feed_sqr) * itp_cur_plan_block->accel_inv;
            ...
            {
                float deaccel_dist = (junction_speed_sqr - exit_speed_sqr) * itp_cur_plan_block->accel_inv;
        ...
        */
        ...
        if(sgm->update_speed)
        {
            float new_speed_sqr = itp_cur_plan_block->acceleration * partial_distance;
