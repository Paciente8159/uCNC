...
//#include "serial.h"
/*
static void set_output(uint32_t apben, GPIO_TypeDef* PORT, uint32_t modeoval, uint32_t configoffset, uint32_t configval)
{
	RCC->APB2ENR |= apben;
	GPIOReg->
}*/
...
#endif
#define RX_BUFFER_SIZE 129
static unsigned char mcu_rx_buffer[RX_BUFFER_SIZE];
...
void mcu_putc(char c)
{
	...
	if (c == '\n' || c == '\r')
	{
		CDC_Transmit_FS((uint8_t*)mcu_rx_buffer, i);
		i = 0;
	}
}
