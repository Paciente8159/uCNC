...
static void test_domain1_c_unsupported_and_modal_conflicts(void)
{
	static const d1_case_t cases[] = {
		D1_CASE("D1-C-001", "G33X1K1", "error:20\r\n"),
// D1_CASE("D1-C-002", "G41", "error:20\r\n"), D1_CASE("D1-C-003", "G42", "error:20\r\n"), // G40/41/42 are ignored and not implemented
// D1_CASE("D1-C-004", "G43Z1", "error:22\r\n"), // supported as well as G43.1Zx
