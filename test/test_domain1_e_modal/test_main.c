...
static const d1_modal_case_t cases[] = {{"D1-E-001", "G20", "G20"},
                                        {"D1-E-002", "G21", "G21"},
                                        {"D1-E-003", "G90", "G90"},
                                        {"D1-E-004", "G91", "G91"},
                                        {"D1-E-005", "G17", "G17"},
...
static void d1_run_current_modal_case(void) {
  ...
  TEST_ASSERT_TRUE_MESSAGE(
      d1_send_line(d1_current_modal_case->command, "ok\r\n"),
      "modal command rejected");
  TEST_ASSERT_TRUE_MESSAGE(
      d1_get_modal(grbl_test_transcript, sizeof(grbl_test_transcript)),
      "could not read modal report");
  TEST_ASSERT_NOT_NULL_MESSAGE(
      strstr(grbl_test_transcript, d1_current_modal_case->modal),
      "expected modal value was not reported by $G");
