...
#endif
#if (defined(STEPPER_ENABLE_PORT) && defined(STEPPER_ENABLE_BIT))
...
#endif
#if (defined(STEPPER1_ENABLE_PORT) && defined(STEPPER1_ENABLE_BIT))
...
#endif
#if (defined(STEPPER2_ENABLE_PORT) && defined(STEPPER2_ENABLE_BIT))
...
#endif
#if (defined(STEPPER3_ENABLE_PORT) && defined(STEPPER3_ENABLE_BIT))
...
#endif
#if (defined(STEPPER4_ENABLE_PORT) && defined(STEPPER4_ENABLE_BIT))
...
#endif
#if (defined(STEPPER5_ENABLE_PORT) && defined(STEPPER5_ENABLE_BIT))
