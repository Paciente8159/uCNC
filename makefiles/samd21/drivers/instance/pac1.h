...
#define REG_PAC1_WPCLR                                                         \
  (0x41000000)                      /**< \brief (PAC1) Write Protection Clear  \
                                     */
#define REG_PAC1_WPSET (0x41000004) /**< \brief (PAC1) Write Protection Set */
#else
#define REG_PAC1_WPCLR                                                         \
  (*(RwReg *)0x41000000UL) /**< \brief (PAC1) Write Protection Clear */
#define REG_PAC1_WPSET                                                         \
  (*(RwReg *)0x41000004UL) /**< \brief (PAC1) Write Protection Set */
