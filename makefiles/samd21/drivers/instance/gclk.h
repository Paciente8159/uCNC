...
#define REG_GCLK_CLKCTRL                                                       \
  (0x40000C02) /**< \brief (GCLK) Generic Clock Control */
#define REG_GCLK_GENCTRL                                                       \
  (0x40000C04) /**< \brief (GCLK) Generic Clock Generator Control */
#define REG_GCLK_GENDIV                                                        \
  (0x40000C08) /**< \brief (GCLK) Generic Clock Generator Division */
#else
#define REG_GCLK_CTRL (*(RwReg8 *)0x40000C00UL)   /**< \brief (GCLK) Control */
#define REG_GCLK_STATUS (*(RoReg8 *)0x40000C01UL) /**< \brief (GCLK) Status */
#define REG_GCLK_CLKCTRL                                                       \
  (*(RwReg16 *)0x40000C02UL) /**< \brief (GCLK) Generic Clock Control */
#define REG_GCLK_GENCTRL                                                       \
  (*(RwReg *)0x40000C04UL) /**< \brief (GCLK) Generic Clock Generator Control  \
                            */
#define REG_GCLK_GENDIV                                                        \
  (*(RwReg *)0x40000C08UL) /**< \brief (GCLK) Generic Clock Generator Division \
                            */
