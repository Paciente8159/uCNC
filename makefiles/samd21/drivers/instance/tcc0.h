...
#define REG_TCC0_SYNCBUSY                                                      \
  (0x42002008) /**< \brief (TCC0) Synchronization Busy */
#define REG_TCC0_FCTRLA                                                        \
  (0x4200200C) /**< \brief (TCC0) Recoverable Fault A Configuration */
#define REG_TCC0_FCTRLB                                                        \
  (0x42002010) /**< \brief (TCC0) Recoverable Fault B Configuration */
#define REG_TCC0_WEXCTRL                                                       \
  (0x42002014) /**< \brief (TCC0) Waveform Extension Configuration */
...
#define REG_TCC0_INTENCLR                                                      \
  (0x42002024) /**< \brief (TCC0) Interrupt Enable Clear */
#define REG_TCC0_INTENSET                                                      \
  (0x42002028) /**< \brief (TCC0) Interrupt Enable Set */
#define REG_TCC0_INTFLAG                                                       \
  (0x4200202C) /**< \brief (TCC0) Interrupt Flag Status and Clear */
...
#define REG_TCC0_WAVEB                                                         \
  (0x42002068)                     /**< \brief (TCC0) Waveform Control Buffer */
#define REG_TCC0_PERB (0x4200206C) /**< \brief (TCC0) Period Buffer */
#define REG_TCC0_CCB0                                                          \
  (0x42002070) /**< \brief (TCC0) Compare and Capture Buffer 0 */
#define REG_TCC0_CCB1                                                          \
  (0x42002074) /**< \brief (TCC0) Compare and Capture Buffer 1 */
#define REG_TCC0_CCB2                                                          \
  (0x42002078) /**< \brief (TCC0) Compare and Capture Buffer 2 */
#define REG_TCC0_CCB3                                                          \
  (0x4200207C) /**< \brief (TCC0) Compare and Capture Buffer 3 */
#else
#define REG_TCC0_CTRLA (*(RwReg *)0x42002000UL) /**< \brief (TCC0) Control A   \
                                                 */
#define REG_TCC0_CTRLBCLR                                                      \
  (*(RwReg8 *)0x42002004UL) /**< \brief (TCC0) Control B Clear */
#define REG_TCC0_CTRLBSET                                                      \
  (*(RwReg8 *)0x42002005UL) /**< \brief (TCC0) Control B Set */
#define REG_TCC0_SYNCBUSY                                                      \
  (*(RoReg *)0x42002008UL) /**< \brief (TCC0) Synchronization Busy */
#define REG_TCC0_FCTRLA                                                        \
  (*(RwReg *)0x4200200CUL) /**< \brief (TCC0) Recoverable Fault A              \
                              Configuration */
#define REG_TCC0_FCTRLB                                                        \
  (*(RwReg *)0x42002010UL) /**< \brief (TCC0) Recoverable Fault B              \
                              Configuration */
#define REG_TCC0_WEXCTRL                                                       \
  (*(RwReg *)0x42002014UL) /**< \brief (TCC0) Waveform Extension Configuration \
                            */
#define REG_TCC0_DRVCTRL                                                       \
  (*(RwReg *)0x42002018UL) /**< \brief (TCC0) Driver Control */
#define REG_TCC0_DBGCTRL                                                       \
  (*(RwReg8 *)0x4200201EUL) /**< \brief (TCC0) Debug Control */
#define REG_TCC0_EVCTRL                                                        \
  (*(RwReg *)0x42002020UL) /**< \brief (TCC0) Event Control */
#define REG_TCC0_INTENCLR                                                      \
  (*(RwReg *)0x42002024UL) /**< \brief (TCC0) Interrupt Enable Clear */
#define REG_TCC0_INTENSET                                                      \
  (*(RwReg *)0x42002028UL) /**< \brief (TCC0) Interrupt Enable Set */
#define REG_TCC0_INTFLAG                                                       \
  (*(RwReg *)0x4200202CUL) /**< \brief (TCC0) Interrupt Flag Status and Clear  \
                            */
...
#define REG_TCC0_WAVE                                                          \
  (*(RwReg *)0x4200203CUL) /**< \brief (TCC0) Waveform Control */
#define REG_TCC0_PER (*(RwReg *)0x42002040UL) /**< \brief (TCC0) Period */
#define REG_TCC0_CC0                                                           \
  (*(RwReg *)0x42002044UL) /**< \brief (TCC0) Compare and Capture 0 */
#define REG_TCC0_CC1                                                           \
  (*(RwReg *)0x42002048UL) /**< \brief (TCC0) Compare and Capture 1 */
#define REG_TCC0_CC2                                                           \
  (*(RwReg *)0x4200204CUL) /**< \brief (TCC0) Compare and Capture 2 */
#define REG_TCC0_CC3                                                           \
  (*(RwReg *)0x42002050UL) /**< \brief (TCC0) Compare and Capture 3 */
#define REG_TCC0_PATTB                                                         \
  (*(RwReg16 *)0x42002064UL) /**< \brief (TCC0) Pattern Buffer */
#define REG_TCC0_WAVEB                                                         \
  (*(RwReg *)0x42002068UL) /**< \brief (TCC0) Waveform Control Buffer */
#define REG_TCC0_PERB                                                          \
  (*(RwReg *)0x4200206CUL) /**< \brief (TCC0) Period Buffer */
#define REG_TCC0_CCB0                                                          \
  (*(RwReg *)0x42002070UL) /**< \brief (TCC0) Compare and Capture Buffer 0 */
#define REG_TCC0_CCB1                                                          \
  (*(RwReg *)0x42002074UL) /**< \brief (TCC0) Compare and Capture Buffer 1 */
#define REG_TCC0_CCB2                                                          \
  (*(RwReg *)0x42002078UL) /**< \brief (TCC0) Compare and Capture Buffer 2 */
#define REG_TCC0_CCB3                                                          \
  (*(RwReg *)0x4200207CUL) /**< \brief (TCC0) Compare and Capture Buffer 3 */
