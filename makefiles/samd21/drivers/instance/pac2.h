...
#define REG_PAC2_WPCLR                                                         \
  (0x42000000)                      /**< \brief (PAC2) Write Protection Clear  \
                                     */
#define REG_PAC2_WPSET (0x42000004) /**< \brief (PAC2) Write Protection Set */
#else
#define REG_PAC2_WPCLR                                                         \
  (*(RwReg *)0x42000000UL) /**< \brief (PAC2) Write Protection Clear */
#define REG_PAC2_WPSET                                                         \
  (*(RwReg *)0x42000004UL) /**< \brief (PAC2) Write Protection Set */
