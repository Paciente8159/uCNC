...
#define REG_NVMCTRL_INTENCLR                                                   \
  (0x4100400C) /**< \brief (NVMCTRL) Interrupt Enable Clear */
#define REG_NVMCTRL_INTENSET                                                   \
  (0x41004010) /**< \brief (NVMCTRL) Interrupt Enable Set */
#define REG_NVMCTRL_INTFLAG                                                    \
  (0x41004014) /**< \brief (NVMCTRL) Interrupt Flag Status and Clear */
...
#else
#define REG_NVMCTRL_CTRLA                                                      \
  (*(RwReg16 *)0x41004000UL) /**< \brief (NVMCTRL) Control A */
#define REG_NVMCTRL_CTRLB                                                      \
  (*(RwReg *)0x41004004UL) /**< \brief (NVMCTRL) Control B */
#define REG_NVMCTRL_PARAM                                                      \
  (*(RwReg *)0x41004008UL) /**< \brief (NVMCTRL) NVM Parameter */
#define REG_NVMCTRL_INTENCLR                                                   \
  (*(RwReg8 *)0x4100400CUL) /**< \brief (NVMCTRL) Interrupt Enable Clear */
#define REG_NVMCTRL_INTENSET                                                   \
  (*(RwReg8 *)0x41004010UL) /**< \brief (NVMCTRL) Interrupt Enable Set */
#define REG_NVMCTRL_INTFLAG                                                    \
  (*(RwReg8 *)0x41004014UL) /**< \brief (NVMCTRL) Interrupt Flag Status and    \
                               Clear */
#define REG_NVMCTRL_STATUS                                                     \
  (*(RwReg16 *)0x41004018UL) /**< \brief (NVMCTRL) Status */
#define REG_NVMCTRL_ADDR                                                       \
  (*(RwReg *)0x4100401CUL) /**< \brief (NVMCTRL) Address */
#define REG_NVMCTRL_LOCK                                                       \
  (*(RwReg16 *)0x41004020UL) /**< \brief (NVMCTRL) Lock Section */
