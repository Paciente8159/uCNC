...
#define REG_TCC1_SYNCBUSY                                                      \
  (0x42002408) /**< \brief (TCC1) Synchronization Busy */
#define REG_TCC1_FCTRLA                                                        \
  (0x4200240C) /**< \brief (TCC1) Recoverable Fault A Configuration */
#define REG_TCC1_FCTRLB                                                        \
  (0x42002410) /**< \brief (TCC1) Recoverable Fault B Configuration */
...
#define REG_TCC1_INTENCLR                                                      \
  (0x42002424) /**< \brief (TCC1) Interrupt Enable Clear */
#define REG_TCC1_INTENSET                                                      \
  (0x42002428) /**< \brief (TCC1) Interrupt Enable Set */
#define REG_TCC1_INTFLAG                                                       \
  (0x4200242C) /**< \brief (TCC1) Interrupt Flag Status and Clear */
...
#define REG_TCC1_WAVEB                                                         \
  (0x42002468)                     /**< \brief (TCC1) Waveform Control Buffer */
#define REG_TCC1_PERB (0x4200246C) /**< \brief (TCC1) Period Buffer */
#define REG_TCC1_CCB0                                                          \
  (0x42002470) /**< \brief (TCC1) Compare and Capture Buffer 0 */
#define REG_TCC1_CCB1                                                          \
  (0x42002474) /**< \brief (TCC1) Compare and Capture Buffer 1 */
#else
#define REG_TCC1_CTRLA (*(RwReg *)0x42002400UL) /**< \brief (TCC1) Control A   \
                                                 */
#define REG_TCC1_CTRLBCLR                                                      \
  (*(RwReg8 *)0x42002404UL) /**< \brief (TCC1) Control B Clear */
#define REG_TCC1_CTRLBSET                                                      \
  (*(RwReg8 *)0x42002405UL) /**< \brief (TCC1) Control B Set */
#define REG_TCC1_SYNCBUSY                                                      \
  (*(RoReg *)0x42002408UL) /**< \brief (TCC1) Synchronization Busy */
#define REG_TCC1_FCTRLA                                                        \
  (*(RwReg *)0x4200240CUL) /**< \brief (TCC1) Recoverable Fault A              \
                              Configuration */
#define REG_TCC1_FCTRLB                                                        \
  (*(RwReg *)0x42002410UL) /**< \brief (TCC1) Recoverable Fault B              \
                              Configuration */
#define REG_TCC1_DRVCTRL                                                       \
  (*(RwReg *)0x42002418UL) /**< \brief (TCC1) Driver Control */
#define REG_TCC1_DBGCTRL                                                       \
  (*(RwReg8 *)0x4200241EUL) /**< \brief (TCC1) Debug Control */
#define REG_TCC1_EVCTRL                                                        \
  (*(RwReg *)0x42002420UL) /**< \brief (TCC1) Event Control */
#define REG_TCC1_INTENCLR                                                      \
  (*(RwReg *)0x42002424UL) /**< \brief (TCC1) Interrupt Enable Clear */
#define REG_TCC1_INTENSET                                                      \
  (*(RwReg *)0x42002428UL) /**< \brief (TCC1) Interrupt Enable Set */
#define REG_TCC1_INTFLAG                                                       \
  (*(RwReg *)0x4200242CUL) /**< \brief (TCC1) Interrupt Flag Status and Clear  \
                            */
...
#define REG_TCC1_WAVE                                                          \
  (*(RwReg *)0x4200243CUL) /**< \brief (TCC1) Waveform Control */
#define REG_TCC1_PER (*(RwReg *)0x42002440UL) /**< \brief (TCC1) Period */
#define REG_TCC1_CC0                                                           \
  (*(RwReg *)0x42002444UL) /**< \brief (TCC1) Compare and Capture 0 */
#define REG_TCC1_CC1                                                           \
  (*(RwReg *)0x42002448UL) /**< \brief (TCC1) Compare and Capture 1 */
#define REG_TCC1_PATTB                                                         \
  (*(RwReg16 *)0x42002464UL) /**< \brief (TCC1) Pattern Buffer */
#define REG_TCC1_WAVEB                                                         \
  (*(RwReg *)0x42002468UL) /**< \brief (TCC1) Waveform Control Buffer */
#define REG_TCC1_PERB                                                          \
  (*(RwReg *)0x4200246CUL) /**< \brief (TCC1) Period Buffer */
#define REG_TCC1_CCB0                                                          \
  (*(RwReg *)0x42002470UL) /**< \brief (TCC1) Compare and Capture Buffer 0 */
#define REG_TCC1_CCB1                                                          \
  (*(RwReg *)0x42002474UL) /**< \brief (TCC1) Compare and Capture Buffer 1 */
