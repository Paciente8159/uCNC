...
#define REG_EVSYS_INTENCLR                                                     \
  (0x42000410) /**< \brief (EVSYS) Interrupt Enable Clear */
#define REG_EVSYS_INTENSET                                                     \
  (0x42000414) /**< \brief (EVSYS) Interrupt Enable Set */
#define REG_EVSYS_INTFLAG                                                      \
  (0x42000418) /**< \brief (EVSYS) Interrupt Flag Status and Clear */
#else
#define REG_EVSYS_CTRL                                                         \
  (*(WoReg8 *)0x42000400UL) /**< \brief (EVSYS) Control                        \
                             */
#define REG_EVSYS_CHANNEL                                                      \
  (*(RwReg *)0x42000404UL) /**< \brief (EVSYS) Channel */
#define REG_EVSYS_USER                                                         \
  (*(RwReg16 *)0x42000408UL) /**< \brief (EVSYS) User Multiplexer */
#define REG_EVSYS_CHSTATUS                                                     \
  (*(RoReg *)0x4200040CUL) /**< \brief (EVSYS) Channel Status */
#define REG_EVSYS_INTENCLR                                                     \
  (*(RwReg *)0x42000410UL) /**< \brief (EVSYS) Interrupt Enable Clear */
#define REG_EVSYS_INTENSET                                                     \
  (*(RwReg *)0x42000414UL) /**< \brief (EVSYS) Interrupt Enable Set */
#define REG_EVSYS_INTFLAG                                                      \
  (*(RwReg *)0x42000418UL) /**< \brief (EVSYS) Interrupt Flag Status and Clear \
                            */
