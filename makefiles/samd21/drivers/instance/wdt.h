...
#define REG_WDT_EWCTRL                                                         \
  (0x40001002) /**< \brief (WDT) Early Warning Interrupt Control */
#define REG_WDT_INTENCLR                                                       \
  (0x40001004) /**< \brief (WDT) Interrupt Enable Clear */
#define REG_WDT_INTENSET (0x40001005) /**< \brief (WDT) Interrupt Enable Set   \
                                       */
#define REG_WDT_INTFLAG                                                        \
  (0x40001006) /**< \brief (WDT) Interrupt Flag Status and Clear */
...
#define REG_WDT_CONFIG                                                         \
  (*(RwReg8 *)0x40001001UL) /**< \brief (WDT) Configuration */
#define REG_WDT_EWCTRL                                                         \
  (*(RwReg8 *)0x40001002UL) /**< \brief (WDT) Early Warning Interrupt Control  \
                             */
#define REG_WDT_INTENCLR                                                       \
  (*(RwReg8 *)0x40001004UL) /**< \brief (WDT) Interrupt Enable Clear */
#define REG_WDT_INTENSET                                                       \
  (*(RwReg8 *)0x40001005UL) /**< \brief (WDT) Interrupt Enable Set */
#define REG_WDT_INTFLAG                                                        \
  (*(RwReg8 *)0x40001006UL) /**< \brief (WDT) Interrupt Flag Status and Clear  \
                             */
