...
#define REG_PAC0_WPCLR                                                         \
  (0x40000000)                      /**< \brief (PAC0) Write Protection Clear  \
                                     */
#define REG_PAC0_WPSET (0x40000004) /**< \brief (PAC0) Write Protection Set */
#else
#define REG_PAC0_WPCLR                                                         \
  (*(RwReg *)0x40000000UL) /**< \brief (PAC0) Write Protection Clear */
#define REG_PAC0_WPSET                                                         \
  (*(RwReg *)0x40000004UL) /**< \brief (PAC0) Write Protection Set */
