...
#define REG_DAC_INTENCLR                                                       \
  (0x42004804) /**< \brief (DAC) Interrupt Enable Clear */
#define REG_DAC_INTENSET                                                       \
  (0x42004805) /**< \brief (DAC) Interrupt Enable Set                          \
                */
#define REG_DAC_INTFLAG                                                        \
  (0x42004806) /**< \brief (DAC) Interrupt Flag Status and Clear */
...
#define REG_DAC_EVCTRL                                                         \
  (*(RwReg8 *)0x42004802UL) /**< \brief (DAC) Event Control */
#define REG_DAC_INTENCLR                                                       \
  (*(RwReg8 *)0x42004804UL) /**< \brief (DAC) Interrupt Enable Clear */
#define REG_DAC_INTENSET                                                       \
  (*(RwReg8 *)0x42004805UL) /**< \brief (DAC) Interrupt Enable Set */
#define REG_DAC_INTFLAG                                                        \
  (*(RwReg8 *)0x42004806UL) /**< \brief (DAC) Interrupt Flag Status and Clear  \
                             */
#define REG_DAC_STATUS (*(RoReg8 *)0x42004807UL) /**< \brief (DAC) Status */
#define REG_DAC_DATA (*(RwReg16 *)0x42004808UL)  /**< \brief (DAC) Data */
#define REG_DAC_DATABUF                                                        \
  (*(RwReg16 *)0x4200480CUL) /**< \brief (DAC) Data Buffer */
