...
#define REG_MTB_ITCTRL                                                         \
  (0x41006F00) /**< \brief (MTB) MTB Integration Mode Control */
...
#define REG_MTB_AUTHSTATUS                                                     \
  (0x41006FB8) /**< \brief (MTB) MTB Authentication Status */
#define REG_MTB_DEVARCH                                                        \
  (0x41006FBC) /**< \brief (MTB) MTB Device Architecture */
#define REG_MTB_DEVID                                                          \
  (0x41006FC8) /**< \brief (MTB) MTB Device Configuration                      \
                */
...
#else
#define REG_MTB_POSITION                                                       \
  (*(RwReg *)0x41006000UL) /**< \brief (MTB) MTB Position */
#define REG_MTB_MASTER                                                         \
  (*(RwReg *)0x41006004UL)                    /**< \brief (MTB) MTB Master     \
                                               */
#define REG_MTB_FLOW (*(RwReg *)0x41006008UL) /**< \brief (MTB) MTB Flow */
#define REG_MTB_BASE (*(RoReg *)0x4100600CUL) /**< \brief (MTB) MTB Base */
#define REG_MTB_ITCTRL                                                         \
  (*(RwReg *)0x41006F00UL) /**< \brief (MTB) MTB Integration Mode Control */
#define REG_MTB_CLAIMSET                                                       \
  (*(RwReg *)0x41006FA0UL) /**< \brief (MTB) MTB Claim Set */
#define REG_MTB_CLAIMCLR                                                       \
  (*(RwReg *)0x41006FA4UL) /**< \brief (MTB) MTB Claim Clear */
#define REG_MTB_LOCKACCESS                                                     \
  (*(RwReg *)0x41006FB0UL) /**< \brief (MTB) MTB Lock Access */
#define REG_MTB_LOCKSTATUS                                                     \
  (*(RoReg *)0x41006FB4UL) /**< \brief (MTB) MTB Lock Status */
#define REG_MTB_AUTHSTATUS                                                     \
  (*(RoReg *)0x41006FB8UL) /**< \brief (MTB) MTB Authentication Status */
#define REG_MTB_DEVARCH                                                        \
  (*(RoReg *)0x41006FBCUL) /**< \brief (MTB) MTB Device Architecture */
#define REG_MTB_DEVID                                                          \
  (*(RoReg *)0x41006FC8UL) /**< \brief (MTB) MTB Device Configuration */
#define REG_MTB_DEVTYPE                                                        \
  (*(RoReg *)0x41006FCCUL) /**< \brief (MTB) MTB Device Type */
