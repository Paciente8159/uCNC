...
#define REG_PM_INTENCLR                                                        \
  (0x40000434)                       /**< \brief (PM) Interrupt Enable Clear   \
                                      */
#define REG_PM_INTENSET (0x40000435) /**< \brief (PM) Interrupt Enable Set */
#define REG_PM_INTFLAG                                                         \
  (0x40000436) /**< \brief (PM) Interrupt Flag Status and Clear */
...
#define REG_PM_CPUSEL                                                          \
  (*(RwReg8 *)0x40000408UL) /**< \brief (PM) CPU Clock Select */
#define REG_PM_APBASEL                                                         \
  (*(RwReg8 *)0x40000409UL) /**< \brief (PM) APBA Clock Select */
#define REG_PM_APBBSEL                                                         \
  (*(RwReg8 *)0x4000040AUL) /**< \brief (PM) APBB Clock Select */
#define REG_PM_APBCSEL                                                         \
  (*(RwReg8 *)0x4000040BUL) /**< \brief (PM) APBC Clock Select */
...
#define REG_PM_INTENCLR                                                        \
  (*(RwReg8 *)0x40000434UL) /**< \brief (PM) Interrupt Enable Clear */
#define REG_PM_INTENSET                                                        \
  (*(RwReg8 *)0x40000435UL) /**< \brief (PM) Interrupt Enable Set */
#define REG_PM_INTFLAG                                                         \
  (*(RwReg8 *)0x40000436UL) /**< \brief (PM) Interrupt Flag Status and Clear   \
                             */
#define REG_PM_RCAUSE                                                          \
  (*(RoReg8 *)0x40000438UL) /**< \brief (PM) Reset Cause                       \
                             */
