...
#define REG_I2S_CLKCTRL0                                                       \
  (0x42005004) /**< \brief (I2S) Clock Unit 0 Control                          \
                */
#define REG_I2S_CLKCTRL1                                                       \
  (0x42005008) /**< \brief (I2S) Clock Unit 1 Control                          \
                */
#define REG_I2S_INTENCLR                                                       \
  (0x4200500C) /**< \brief (I2S) Interrupt Enable Clear */
#define REG_I2S_INTENSET                                                       \
  (0x42005010) /**< \brief (I2S) Interrupt Enable Set                          \
                */
#define REG_I2S_INTFLAG                                                        \
  (0x42005014) /**< \brief (I2S) Interrupt Flag Status and Clear */
#define REG_I2S_SYNCBUSY                                                       \
  (0x42005018) /**< \brief (I2S) Synchronization Status */
#define REG_I2S_SERCTRL0                                                       \
  (0x42005020) /**< \brief (I2S) Serializer 0 Control                          \
                */
#define REG_I2S_SERCTRL1                                                       \
  (0x42005024)                     /**< \brief (I2S) Serializer 1 Control      \
                                    */
...
#define REG_I2S_CLKCTRL0                                                       \
  (*(RwReg *)0x42005004UL) /**< \brief (I2S) Clock Unit 0 Control */
#define REG_I2S_CLKCTRL1                                                       \
  (*(RwReg *)0x42005008UL) /**< \brief (I2S) Clock Unit 1 Control */
#define REG_I2S_INTENCLR                                                       \
  (*(RwReg16 *)0x4200500CUL) /**< \brief (I2S) Interrupt Enable Clear */
#define REG_I2S_INTENSET                                                       \
  (*(RwReg16 *)0x42005010UL) /**< \brief (I2S) Interrupt Enable Set */
#define REG_I2S_INTFLAG                                                        \
  (*(RwReg16                                                                   \
         *)0x42005014UL) /**< \brief (I2S) Interrupt Flag Status and Clear */
#define REG_I2S_SYNCBUSY                                                       \
  (*(RoReg16 *)0x42005018UL) /**< \brief (I2S) Synchronization Status */
#define REG_I2S_SERCTRL0                                                       \
  (*(RwReg *)0x42005020UL) /**< \brief (I2S) Serializer 0 Control */
#define REG_I2S_SERCTRL1                                                       \
  (*(RwReg *)0x42005024UL) /**< \brief (I2S) Serializer 1 Control */
