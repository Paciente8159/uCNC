...
#define REG_AC_INTENCLR                                                        \
  (0x42004404)                       /**< \brief (AC) Interrupt Enable Clear   \
                                      */
#define REG_AC_INTENSET (0x42004405) /**< \brief (AC) Interrupt Enable Set */
#define REG_AC_INTFLAG                                                         \
  (0x42004406) /**< \brief (AC) Interrupt Flag Status and Clear */
...
#define REG_AC_EVCTRL                                                          \
  (*(RwReg16 *)0x42004402UL) /**< \brief (AC) Event Control */
#define REG_AC_INTENCLR                                                        \
  (*(RwReg8 *)0x42004404UL) /**< \brief (AC) Interrupt Enable Clear */
#define REG_AC_INTENSET                                                        \
  (*(RwReg8 *)0x42004405UL) /**< \brief (AC) Interrupt Enable Set */
#define REG_AC_INTFLAG                                                         \
  (*(RwReg8 *)0x42004406UL) /**< \brief (AC) Interrupt Flag Status and Clear   \
                             */
...
#define REG_AC_WINCTRL                                                         \
  (*(RwReg8 *)0x4200440CUL) /**< \brief (AC) Window Control */
#define REG_AC_COMPCTRL0                                                       \
  (*(RwReg *)0x42004410UL) /**< \brief (AC) Comparator Control 0 */
#define REG_AC_COMPCTRL1                                                       \
  (*(RwReg *)0x42004414UL) /**< \brief (AC) Comparator Control 1 */
