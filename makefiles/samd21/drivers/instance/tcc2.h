...
#define REG_TCC2_SYNCBUSY                                                      \
  (0x42002808) /**< \brief (TCC2) Synchronization Busy */
#define REG_TCC2_FCTRLA                                                        \
  (0x4200280C) /**< \brief (TCC2) Recoverable Fault A Configuration */
#define REG_TCC2_FCTRLB                                                        \
  (0x42002810) /**< \brief (TCC2) Recoverable Fault B Configuration */
...
#define REG_TCC2_INTENCLR                                                      \
  (0x42002824) /**< \brief (TCC2) Interrupt Enable Clear */
#define REG_TCC2_INTENSET                                                      \
  (0x42002828) /**< \brief (TCC2) Interrupt Enable Set */
#define REG_TCC2_INTFLAG                                                       \
  (0x4200282C) /**< \brief (TCC2) Interrupt Flag Status and Clear */
...
#define REG_TCC2_WAVEB                                                         \
  (0x42002868)                     /**< \brief (TCC2) Waveform Control Buffer */
#define REG_TCC2_PERB (0x4200286C) /**< \brief (TCC2) Period Buffer */
#define REG_TCC2_CCB0                                                          \
  (0x42002870) /**< \brief (TCC2) Compare and Capture Buffer 0 */
#define REG_TCC2_CCB1                                                          \
  (0x42002874) /**< \brief (TCC2) Compare and Capture Buffer 1 */
#else
#define REG_TCC2_CTRLA (*(RwReg *)0x42002800UL) /**< \brief (TCC2) Control A   \
                                                 */
#define REG_TCC2_CTRLBCLR                                                      \
  (*(RwReg8 *)0x42002804UL) /**< \brief (TCC2) Control B Clear */
#define REG_TCC2_CTRLBSET                                                      \
  (*(RwReg8 *)0x42002805UL) /**< \brief (TCC2) Control B Set */
#define REG_TCC2_SYNCBUSY                                                      \
  (*(RoReg *)0x42002808UL) /**< \brief (TCC2) Synchronization Busy */
#define REG_TCC2_FCTRLA                                                        \
  (*(RwReg *)0x4200280CUL) /**< \brief (TCC2) Recoverable Fault A              \
                              Configuration */
#define REG_TCC2_FCTRLB                                                        \
  (*(RwReg *)0x42002810UL) /**< \brief (TCC2) Recoverable Fault B              \
                              Configuration */
#define REG_TCC2_DRVCTRL                                                       \
  (*(RwReg *)0x42002818UL) /**< \brief (TCC2) Driver Control */
#define REG_TCC2_DBGCTRL                                                       \
  (*(RwReg8 *)0x4200281EUL) /**< \brief (TCC2) Debug Control */
#define REG_TCC2_EVCTRL                                                        \
  (*(RwReg *)0x42002820UL) /**< \brief (TCC2) Event Control */
#define REG_TCC2_INTENCLR                                                      \
  (*(RwReg *)0x42002824UL) /**< \brief (TCC2) Interrupt Enable Clear */
#define REG_TCC2_INTENSET                                                      \
  (*(RwReg *)0x42002828UL) /**< \brief (TCC2) Interrupt Enable Set */
#define REG_TCC2_INTFLAG                                                       \
  (*(RwReg *)0x4200282CUL) /**< \brief (TCC2) Interrupt Flag Status and Clear  \
                            */
#define REG_TCC2_STATUS (*(RwReg *)0x42002830UL) /**< \brief (TCC2) Status */
#define REG_TCC2_COUNT (*(RwReg *)0x42002834UL)  /**< \brief (TCC2) Count */
#define REG_TCC2_WAVE                                                          \
  (*(RwReg *)0x4200283CUL) /**< \brief (TCC2) Waveform Control */
#define REG_TCC2_PER (*(RwReg *)0x42002840UL) /**< \brief (TCC2) Period */
#define REG_TCC2_CC0                                                           \
  (*(RwReg *)0x42002844UL) /**< \brief (TCC2) Compare and Capture 0 */
#define REG_TCC2_CC1                                                           \
  (*(RwReg *)0x42002848UL) /**< \brief (TCC2) Compare and Capture 1 */
#define REG_TCC2_WAVEB                                                         \
  (*(RwReg *)0x42002868UL) /**< \brief (TCC2) Waveform Control Buffer */
#define REG_TCC2_PERB                                                          \
  (*(RwReg *)0x4200286CUL) /**< \brief (TCC2) Period Buffer */
#define REG_TCC2_CCB0                                                          \
  (*(RwReg *)0x42002870UL) /**< \brief (TCC2) Compare and Capture Buffer 0 */
#define REG_TCC2_CCB1                                                          \
  (*(RwReg *)0x42002874UL) /**< \brief (TCC2) Compare and Capture Buffer 1 */
