...
typedef volatile const uint16_t
    RoReg16; /**< Read only 16-bit register (volatile const unsigned int) */
typedef volatile const uint8_t
    RoReg8; /**< Read only  8-bit register (volatile const unsigned int) */
#else
...
typedef volatile uint16_t
    WoReg16; /**< Write only 16-bit register (volatile unsigned int) */
typedef volatile uint8_t
    WoReg8; /**< Write only  8-bit register (volatile unsigned int) */
typedef volatile uint32_t
    RwReg; /**< Read-Write 32-bit register (volatile unsigned int) */
typedef volatile uint16_t
    RwReg16; /**< Read-Write 16-bit register (volatile unsigned int) */
typedef volatile uint8_t
    RwReg8; /**< Read-Write  8-bit register (volatile unsigned int) */
#endif
...
typedef enum IRQn {
  ...
  NVMCTRL_IRQn =
      5,         /**<  5 SAMD21G17AU Non-Volatile Memory Controller (NVMCTRL) */
  ...
  SERCOM0_IRQn =
      9, /**<  9 SAMD21G17AU Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn =
      10, /**< 10 SAMD21G17AU Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn =
      11, /**< 11 SAMD21G17AU Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn =
      12, /**< 12 SAMD21G17AU Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn =
      13, /**< 13 SAMD21G17AU Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn =
      14, /**< 14 SAMD21G17AU Serial Communication Interface 5 (SERCOM5) */
...
#define ID_SERCOM0                                                             \
  66 /**< \brief Serial Communication Interface 0 (SERCOM0)                    \
      */
#define ID_SERCOM1                                                             \
  67 /**< \brief Serial Communication Interface 1 (SERCOM1)                    \
      */
#define ID_SERCOM2                                                             \
  68 /**< \brief Serial Communication Interface 2 (SERCOM2)                    \
      */
#define ID_SERCOM3                                                             \
  69 /**< \brief Serial Communication Interface 3 (SERCOM3)                    \
      */
#define ID_SERCOM4                                                             \
  70 /**< \brief Serial Communication Interface 4 (SERCOM4)                    \
      */
#define ID_SERCOM5                                                             \
  71               /**< \brief Serial Communication Interface 5 (SERCOM5)      \
                    */
...
#define NVMCTRL_LOCKBIT                                                        \
  (0x00802000)                    /**< \brief (NVMCTRL) LOCKBIT Base Address */
...
#define NVMCTRL_TEMP_LOG                                                       \
  (0x00806030)                    /**< \brief (NVMCTRL) TEMP_LOG Base Address */
...
#define SBMATRIX                                                               \
  ((Hmatrixb *)0x41007000UL)      /**< \brief (SBMATRIX) APB Base Address */
...
#define NVMCTRL                                                                \
  ((Nvmctrl *)0x41004000UL)        /**< \brief (NVMCTRL) APB Base Address */
#define NVMCTRL_CAL (0x00800000UL) /**< \brief (NVMCTRL) CAL Base Address */
#define NVMCTRL_LOCKBIT                                                        \
  (0x00802000UL) /**< \brief (NVMCTRL) LOCKBIT Base Address */
...
#define NVMCTRL_TEMP_LOG                                                       \
  (0x00806030UL) /**< \brief (NVMCTRL) TEMP_LOG Base Address */
...
#define PORT_IOBUS                                                             \
  ((Port *)0x60000000UL)              /**< \brief (PORT) IOBUS Base Address */
...
#define SERCOM0                                                                \
  ((Sercom *)0x42000800UL) /**< \brief (SERCOM0) APB Base Address */
#define SERCOM1                                                                \
  ((Sercom *)0x42000C00UL) /**< \brief (SERCOM1) APB Base Address */
#define SERCOM2                                                                \
  ((Sercom *)0x42001000UL) /**< \brief (SERCOM2) APB Base Address */
#define SERCOM3                                                                \
  ((Sercom *)0x42001400UL) /**< \brief (SERCOM3) APB Base Address */
#define SERCOM4                                                                \
  ((Sercom *)0x42001800UL) /**< \brief (SERCOM4) APB Base Address */
#define SERCOM5                                                                \
  ((Sercom *)0x42001C00UL) /**< \brief (SERCOM5) APB Base Address */
...
#define SYSCTRL                                                                \
  ((Sysctrl *)0x40000800UL)     /**< \brief (SYSCTRL) APB Base Address */
...
#define FLASH_USER_PAGE_ADDR                                                   \
  _UL_(0x00800000)                     /**< FLASH_USER_PAGE base address */
...
#define DSU_DID_RESETVALUE _UL_(0x10010310)
