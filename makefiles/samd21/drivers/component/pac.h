...
#define PAC_WPCLR_OFFSET                                                       \
  0x0 /**< \brief (PAC_WPCLR offset) Write Protection Clear */
#define PAC_WPCLR_RESETVALUE                                                   \
  _U_(0x00000000) /**< \brief (PAC_WPCLR reset_value) Write Protection Clear   \
                   */
...
#define PAC_WPCLR_MASK                                                         \
  _U_(0xFFFFFFFE) /**< \brief (PAC_WPCLR) MASK Register                        \
                   */
...
#define PAC_WPSET_OFFSET                                                       \
  0x4 /**< \brief (PAC_WPSET offset) Write Protection Set */
#define PAC_WPSET_RESETVALUE                                                   \
  _U_(0x00000000) /**< \brief (PAC_WPSET reset_value) Write Protection Set */
...
#define PAC_WPSET_MASK                                                         \
  _U_(0xFFFFFFFE) /**< \brief (PAC_WPSET) MASK Register                        \
                   */
