...
#define DSU_CTRL_RESETVALUE                                                    \
  _U_(0x00) /**< \brief (DSU_CTRL reset_value) Control */

#define DSU_CTRL_SWRST_Pos 0 /**< \brief (DSU_CTRL) Software Reset */
#define DSU_CTRL_SWRST (_U_(0x1) << DSU_CTRL_SWRST_Pos)
#define DSU_CTRL_CRC_Pos                                                       \
  2 /**< \brief (DSU_CTRL) 32-bit Cyclic Redundancy Check */
#define DSU_CTRL_CRC (_U_(0x1) << DSU_CTRL_CRC_Pos)
#define DSU_CTRL_MBIST_Pos                                                     \
  3 /**< \brief (DSU_CTRL) Memory Built-In Self-Test                           \
     */
...
#define DSU_STATUSA_RESETVALUE                                                 \
  _U_(0x00) /**< \brief (DSU_STATUSA reset_value) Status A */
...
#define DSU_STATUSA_CRSTEXT_Pos                                                \
  1 /**< \brief (DSU_STATUSA) CPU Reset Phase Extension */
...
#define DSU_STATUSB_RESETVALUE                                                 \
  _U_(0x10) /**< \brief (DSU_STATUSB reset_value) Status B */

#define DSU_STATUSB_PROT_Pos 0 /**< \brief (DSU_STATUSB) Protected */
#define DSU_STATUSB_PROT (_U_(0x1) << DSU_STATUSB_PROT_Pos)
#define DSU_STATUSB_DBGPRES_Pos                                                \
  1 /**< \brief (DSU_STATUSB) Debugger Present                                 \
     */
#define DSU_STATUSB_DBGPRES (_U_(0x1) << DSU_STATUSB_DBGPRES_Pos)
#define DSU_STATUSB_DCCD0_Pos                                                  \
  2 /**< \brief (DSU_STATUSB) Debug Communication Channel 0 Dirty */
#define DSU_STATUSB_DCCD0 (_U_(1) << DSU_STATUSB_DCCD0_Pos)
#define DSU_STATUSB_DCCD1_Pos                                                  \
  3 /**< \brief (DSU_STATUSB) Debug Communication Channel 1 Dirty */
#define DSU_STATUSB_DCCD1 (_U_(1) << DSU_STATUSB_DCCD1_Pos)
#define DSU_STATUSB_DCCD_Pos                                                   \
  2 /**< \brief (DSU_STATUSB) Debug Communication Channel x Dirty */
#define DSU_STATUSB_DCCD_Msk (_U_(0x3) << DSU_STATUSB_DCCD_Pos)
#define DSU_STATUSB_DCCD(value)                                                \
  (DSU_STATUSB_DCCD_Msk & ((value) << DSU_STATUSB_DCCD_Pos))
...
#define DSU_ADDR_RESETVALUE                                                    \
  _U_(0x00000000) /**< \brief (DSU_ADDR reset_value) Address */

#define DSU_ADDR_ADDR_Pos 2 /**< \brief (DSU_ADDR) Address */
#define DSU_ADDR_ADDR_Msk (_U_(0x3FFFFFFF) << DSU_ADDR_ADDR_Pos)
#define DSU_ADDR_ADDR(value)                                                   \
  (DSU_ADDR_ADDR_Msk & ((value) << DSU_ADDR_ADDR_Pos))
...
#define DSU_LENGTH_RESETVALUE                                                  \
  _U_(0x00000000) /**< \brief (DSU_LENGTH reset_value) Length */

#define DSU_LENGTH_LENGTH_Pos 2 /**< \brief (DSU_LENGTH) Length */
#define DSU_LENGTH_LENGTH_Msk (_U_(0x3FFFFFFF) << DSU_LENGTH_LENGTH_Pos)
#define DSU_LENGTH_LENGTH(value)                                               \
  (DSU_LENGTH_LENGTH_Msk & ((value) << DSU_LENGTH_LENGTH_Pos))
#define DSU_LENGTH_MASK                                                        \
  _U_(0xFFFFFFFC) /**< \brief (DSU_LENGTH) MASK Register */
...
#define DSU_DATA_RESETVALUE                                                    \
  _U_(0x00000000) /**< \brief (DSU_DATA reset_value) Data */
...
#define DSU_DATA_DATA(value)                                                   \
  (DSU_DATA_DATA_Msk & ((value) << DSU_DATA_DATA_Pos))
#define DSU_DATA_MASK _U_(0xFFFFFFFF) /**< \brief (DSU_DATA) MASK Register */

/* -------- DSU_DCC : (DSU Offset: 0x0010) (R/W 32) Debug Communication Channel
 * n -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define DSU_DCC_OFFSET                                                         \
  0x0010 /**< \brief (DSU_DCC offset) Debug Communication Channel n */
#define DSU_DCC_RESETVALUE                                                     \
  _U_(0x00000000) /**< \brief (DSU_DCC reset_value) Debug Communication        \
                     Channel n */
...
#define DSU_DID_OFFSET                                                         \
  0x0018 /**< \brief (DSU_DID offset) Device Identification */

#define DSU_DID_DEVSEL_Pos 0 /**< \brief (DSU_DID) Device Select */
#define DSU_DID_DEVSEL_Msk (_U_(0xFF) << DSU_DID_DEVSEL_Pos)
#define DSU_DID_DEVSEL(value)                                                  \
  (DSU_DID_DEVSEL_Msk & ((value) << DSU_DID_DEVSEL_Pos))
#define DSU_DID_REVISION_Pos 8 /**< \brief (DSU_DID) Revision */
#define DSU_DID_REVISION_Msk (_U_(0xF) << DSU_DID_REVISION_Pos)
#define DSU_DID_REVISION(value)                                                \
  (DSU_DID_REVISION_Msk & ((value) << DSU_DID_REVISION_Pos))
...
#define DSU_ENTRY_OFFSET                                                       \
  0x1000 /**< \brief (DSU_ENTRY offset) CoreSight ROM Table Entry 0 */
#define DSU_ENTRY_RESETVALUE                                                   \
  _U_(0x9F9FC002) /**< \brief (DSU_ENTRY reset_value) CoreSight ROM Table      \
                     Entry 0 */
...
#define DSU_ENTRY_ADDOFF(value)                                                \
  (DSU_ENTRY_ADDOFF_Msk & ((value) << DSU_ENTRY_ADDOFF_Pos))
#define DSU_ENTRY_MASK                                                         \
  _U_(0xFFFFF003) /**< \brief (DSU_ENTRY) MASK Register                        \
                   */

/* -------- DSU_ENTRY1 : (DSU Offset: 0x1004) (R/  32) CoreSight ROM Table Entry
 * 1 -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  uint32_t reg; /*!< Type      used for register access              */
...
#define DSU_ENTRY1_OFFSET                                                      \
  0x1004 /**< \brief (DSU_ENTRY1 offset) CoreSight ROM Table Entry 1 */
#define DSU_ENTRY1_RESETVALUE                                                  \
  _U_(0x00003002) /**< \brief (DSU_ENTRY1 reset_value) CoreSight ROM Table     \
                     Entry 1 */
#define DSU_ENTRY1_MASK                                                        \
  _U_(0xFFFFFFFF) /**< \brief (DSU_ENTRY1) MASK Register */
...
#define DSU_END_OFFSET                                                         \
  0x1008 /**< \brief (DSU_END offset) CoreSight ROM Table End */
#define DSU_END_RESETVALUE                                                     \
  _U_(0x00000000) /**< \brief (DSU_END reset_value) CoreSight ROM Table End */
...
/* -------- DSU_MEMTYPE : (DSU Offset: 0x1FCC) (R/  32) CoreSight ROM Table
 * Memory Type -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define DSU_MEMTYPE_OFFSET                                                     \
  0x1FCC /**< \brief (DSU_MEMTYPE offset) CoreSight ROM Table Memory Type */
#define DSU_MEMTYPE_RESETVALUE                                                 \
  _U_(0x00000000) /**< \brief (DSU_MEMTYPE reset_value) CoreSight ROM Table    \
                     Memory Type */

#define DSU_MEMTYPE_SMEMP_Pos                                                  \
  0 /**< \brief (DSU_MEMTYPE) System Memory Present */
#define DSU_MEMTYPE_SMEMP (_U_(0x1) << DSU_MEMTYPE_SMEMP_Pos)
#define DSU_MEMTYPE_MASK                                                       \
  _U_(0x00000001) /**< \brief (DSU_MEMTYPE) MASK Register */
...
#define DSU_PID4_OFFSET                                                        \
  0x1FD0 /**< \brief (DSU_PID4 offset) Peripheral Identification 4 */
#define DSU_PID4_RESETVALUE                                                    \
  _U_(0x00000000) /**< \brief (DSU_PID4 reset_value) Peripheral Identification \
                     4 */

#define DSU_PID4_JEPCC_Pos                                                     \
  0 /**< \brief (DSU_PID4) JEP-106 Continuation Code                           \
     */
#define DSU_PID4_JEPCC_Msk (_U_(0xF) << DSU_PID4_JEPCC_Pos)
#define DSU_PID4_JEPCC(value)                                                  \
  (DSU_PID4_JEPCC_Msk & ((value) << DSU_PID4_JEPCC_Pos))
#define DSU_PID4_FKBC_Pos 4 /**< \brief (DSU_PID4) 4KB Count */
#define DSU_PID4_FKBC_Msk (_U_(0xF) << DSU_PID4_FKBC_Pos)
#define DSU_PID4_FKBC(value)                                                   \
  (DSU_PID4_FKBC_Msk & ((value) << DSU_PID4_FKBC_Pos))
...
#define DSU_PID0_OFFSET                                                        \
  0x1FE0 /**< \brief (DSU_PID0 offset) Peripheral Identification 0 */
#define DSU_PID0_RESETVALUE                                                    \
  _U_(0x000000D0) /**< \brief (DSU_PID0 reset_value) Peripheral Identification \
                     0 */

#define DSU_PID0_PARTNBL_Pos 0 /**< \brief (DSU_PID0) Part Number Low */
#define DSU_PID0_PARTNBL_Msk (_U_(0xFF) << DSU_PID0_PARTNBL_Pos)
#define DSU_PID0_PARTNBL(value)                                                \
  (DSU_PID0_PARTNBL_Msk & ((value) << DSU_PID0_PARTNBL_Pos))
...
typedef union {
  struct {
    ...
    uint32_t JEPIDCL
        : 4;       /*!< bit:  4.. 7  Low part of the JEP-106 Identity Code */
    uint32_t : 24; /*!< bit:  8..31  Reserved                           */
  } bit;           /*!< Structure used for bit  access                  */
  uint32_t reg;    /*!< Type      used for register access              */
} DSU_PID1_Type;
...
#define DSU_PID1_OFFSET                                                        \
  0x1FE4 /**< \brief (DSU_PID1 offset) Peripheral Identification 1 */
#define DSU_PID1_RESETVALUE                                                    \
  _U_(0x000000FC) /**< \brief (DSU_PID1 reset_value) Peripheral Identification \
                     1 */

#define DSU_PID1_PARTNBH_Pos 0 /**< \brief (DSU_PID1) Part Number High */
#define DSU_PID1_PARTNBH_Msk (_U_(0xF) << DSU_PID1_PARTNBH_Pos)
#define DSU_PID1_PARTNBH(value)                                                \
  (DSU_PID1_PARTNBH_Msk & ((value) << DSU_PID1_PARTNBH_Pos))
#define DSU_PID1_JEPIDCL_Pos                                                   \
  4 /**< \brief (DSU_PID1) Low part of the JEP-106 Identity Code */
#define DSU_PID1_JEPIDCL_Msk (_U_(0xF) << DSU_PID1_JEPIDCL_Pos)
#define DSU_PID1_JEPIDCL(value)                                                \
  (DSU_PID1_JEPIDCL_Msk & ((value) << DSU_PID1_JEPIDCL_Pos))
...
#define DSU_PID2_OFFSET                                                        \
  0x1FE8 /**< \brief (DSU_PID2 offset) Peripheral Identification 2 */
#define DSU_PID2_RESETVALUE                                                    \
  _U_(0x00000009) /**< \brief (DSU_PID2 reset_value) Peripheral Identification \
                     2 */

#define DSU_PID2_JEPIDCH_Pos                                                   \
  0 /**< \brief (DSU_PID2) JEP-106 Identity Code High */
#define DSU_PID2_JEPIDCH_Msk (_U_(0x7) << DSU_PID2_JEPIDCH_Pos)
#define DSU_PID2_JEPIDCH(value)                                                \
  (DSU_PID2_JEPIDCH_Msk & ((value) << DSU_PID2_JEPIDCH_Pos))
#define DSU_PID2_JEPU_Pos                                                      \
  3 /**< \brief (DSU_PID2) JEP-106 Identity Code is used */
...
#define DSU_PID2_REVISION(value)                                               \
  (DSU_PID2_REVISION_Msk & ((value) << DSU_PID2_REVISION_Pos))
...
#define DSU_PID3_OFFSET                                                        \
  0x1FEC /**< \brief (DSU_PID3 offset) Peripheral Identification 3 */
#define DSU_PID3_RESETVALUE                                                    \
  _U_(0x00000000) /**< \brief (DSU_PID3 reset_value) Peripheral Identification \
                     3 */

#define DSU_PID3_CUSMOD_Pos 0 /**< \brief (DSU_PID3) ARM CUSMOD */
#define DSU_PID3_CUSMOD_Msk (_U_(0xF) << DSU_PID3_CUSMOD_Pos)
#define DSU_PID3_CUSMOD(value)                                                 \
  (DSU_PID3_CUSMOD_Msk & ((value) << DSU_PID3_CUSMOD_Pos))
#define DSU_PID3_REVAND_Pos 4 /**< \brief (DSU_PID3) Revision Number */
#define DSU_PID3_REVAND_Msk (_U_(0xF) << DSU_PID3_REVAND_Pos)
#define DSU_PID3_REVAND(value)                                                 \
  (DSU_PID3_REVAND_Msk & ((value) << DSU_PID3_REVAND_Pos))
...
#define DSU_CID0_OFFSET                                                        \
  0x1FF0 /**< \brief (DSU_CID0 offset) Component Identification 0 */
#define DSU_CID0_RESETVALUE                                                    \
  _U_(0x0000000D) /**< \brief (DSU_CID0 reset_value) Component Identification  \
                     0 */
...
#define DSU_CID0_PREAMBLEB0(value)                                             \
  (DSU_CID0_PREAMBLEB0_Msk & ((value) << DSU_CID0_PREAMBLEB0_Pos))
...
#define DSU_CID1_OFFSET                                                        \
  0x1FF4 /**< \brief (DSU_CID1 offset) Component Identification 1 */
#define DSU_CID1_RESETVALUE                                                    \
  _U_(0x00000010) /**< \brief (DSU_CID1 reset_value) Component Identification  \
                     1 */

#define DSU_CID1_PREAMBLE_Pos 0 /**< \brief (DSU_CID1) Preamble */
#define DSU_CID1_PREAMBLE_Msk (_U_(0xF) << DSU_CID1_PREAMBLE_Pos)
#define DSU_CID1_PREAMBLE(value)                                               \
  (DSU_CID1_PREAMBLE_Msk & ((value) << DSU_CID1_PREAMBLE_Pos))
#define DSU_CID1_CCLASS_Pos 4 /**< \brief (DSU_CID1) Component Class */
#define DSU_CID1_CCLASS_Msk (_U_(0xF) << DSU_CID1_CCLASS_Pos)
#define DSU_CID1_CCLASS(value)                                                 \
  (DSU_CID1_CCLASS_Msk & ((value) << DSU_CID1_CCLASS_Pos))
...
#define DSU_CID2_OFFSET                                                        \
  0x1FF8 /**< \brief (DSU_CID2 offset) Component Identification 2 */
#define DSU_CID2_RESETVALUE                                                    \
  _U_(0x00000005) /**< \brief (DSU_CID2 reset_value) Component Identification  \
                     2 */
...
#define DSU_CID2_PREAMBLEB2(value)                                             \
  (DSU_CID2_PREAMBLEB2_Msk & ((value) << DSU_CID2_PREAMBLEB2_Pos))
...
#define DSU_CID3_OFFSET                                                        \
  0x1FFC /**< \brief (DSU_CID3 offset) Component Identification 3 */
#define DSU_CID3_RESETVALUE                                                    \
  _U_(0x000000B1) /**< \brief (DSU_CID3 reset_value) Component Identification  \
                     3 */
...
#define DSU_CID3_PREAMBLEB3(value)                                             \
  (DSU_CID3_PREAMBLEB3_Msk & ((value) << DSU_CID3_PREAMBLEB3_Pos))
...
typedef struct {
  ...
  __IO DSU_DCC_Type DCC[2];    /**< \brief Offset: 0x0010 (R/W 32) Debug
                                  Communication Channel n */
  __I DSU_DID_Type
      DID; /**< \brief Offset: 0x0018 (R/  32) Device Identification */
  RoReg8 Reserved2[0xFE4];
  __I DSU_ENTRY_Type
      ENTRY; /**< \brief Offset: 0x1000 (R/  32) CoreSight ROM Table Entry 0 */
  __I DSU_ENTRY1_Type
      ENTRY1; /**< \brief Offset: 0x1004 (R/  32) CoreSight ROM Table Entry 1 */
  __I DSU_END_Type
      END; /**< \brief Offset: 0x1008 (R/  32) CoreSight ROM Table End */
  RoReg8 Reserved3[0xFC0];
  __I DSU_MEMTYPE_Type MEMTYPE; /**< \brief Offset: 0x1FCC (R/  32) CoreSight
                                   ROM Table Memory Type */
  __I DSU_PID4_Type
      PID4; /**< \brief Offset: 0x1FD0 (R/  32) Peripheral Identification 4 */
  RoReg8 Reserved4[0xC];
  __I DSU_PID0_Type
      PID0; /**< \brief Offset: 0x1FE0 (R/  32) Peripheral Identification 0 */
  __I DSU_PID1_Type
      PID1; /**< \brief Offset: 0x1FE4 (R/  32) Peripheral Identification 1 */
  __I DSU_PID2_Type
      PID2; /**< \brief Offset: 0x1FE8 (R/  32) Peripheral Identification 2 */
  __I DSU_PID3_Type
      PID3; /**< \brief Offset: 0x1FEC (R/  32) Peripheral Identification 3 */
  __I DSU_CID0_Type
      CID0; /**< \brief Offset: 0x1FF0 (R/  32) Component Identification 0 */
  __I DSU_CID1_Type
      CID1; /**< \brief Offset: 0x1FF4 (R/  32) Component Identification 1 */
  __I DSU_CID2_Type
      CID2; /**< \brief Offset: 0x1FF8 (R/  32) Component Identification 2 */
  __I DSU_CID3_Type
      CID3; /**< \brief Offset: 0x1FFC (R/  32) Component Identification 3 */
} Dsu;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
