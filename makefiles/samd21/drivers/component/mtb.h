...
#define MTB_POSITION_OFFSET                                                    \
  0x000 /**< \brief (MTB_POSITION offset) MTB Position */

#define MTB_POSITION_WRAP_Pos                                                  \
  2 /**< \brief (MTB_POSITION) Pointer Value Wraps */
#define MTB_POSITION_WRAP (_U_(0x1) << MTB_POSITION_WRAP_Pos)
#define MTB_POSITION_POINTER_Pos                                               \
  3 /**< \brief (MTB_POSITION) Trace Packet Location Pointer */
#define MTB_POSITION_POINTER_Msk (_U_(0x1FFFFFFF) << MTB_POSITION_POINTER_Pos)
#define MTB_POSITION_POINTER(value)                                            \
  (MTB_POSITION_POINTER_Msk & ((value) << MTB_POSITION_POINTER_Pos))
#define MTB_POSITION_MASK                                                      \
  _U_(0xFFFFFFFC) /**< \brief (MTB_POSITION) MASK Register */
...
typedef union {
  struct {
    uint32_t MASK
        : 5; /*!< bit:  0.. 4  Maximum Value of the Trace Buffer in SRAM */
    uint32_t TSTARTEN : 1; /*!< bit:      5  Trace Start Input Enable */
    uint32_t TSTOPEN : 1;  /*!< bit:      6  Trace Stop Input Enable */
    uint32_t SFRWPRIV
        : 1; /*!< bit:      7  Special Function Register Write Privilege */
...
#define MTB_MASTER_RESETVALUE                                                  \
  _U_(0x00000000) /**< \brief (MTB_MASTER reset_value) MTB Master */

#define MTB_MASTER_MASK_Pos                                                    \
  0 /**< \brief (MTB_MASTER) Maximum Value of the Trace Buffer in SRAM */
#define MTB_MASTER_MASK_Msk (_U_(0x1F) << MTB_MASTER_MASK_Pos)
#define MTB_MASTER_MASK(value)                                                 \
  (MTB_MASTER_MASK_Msk & ((value) << MTB_MASTER_MASK_Pos))
#define MTB_MASTER_TSTARTEN_Pos                                                \
  5 /**< \brief (MTB_MASTER) Trace Start Input Enable */
#define MTB_MASTER_TSTARTEN (_U_(0x1) << MTB_MASTER_TSTARTEN_Pos)
#define MTB_MASTER_TSTOPEN_Pos                                                 \
  6 /**< \brief (MTB_MASTER) Trace Stop Input Enable */
#define MTB_MASTER_TSTOPEN (_U_(0x1) << MTB_MASTER_TSTOPEN_Pos)
#define MTB_MASTER_SFRWPRIV_Pos                                                \
  7 /**< \brief (MTB_MASTER) Special Function Register Write Privilege */
...
#define MTB_MASTER_MASK_                                                       \
  _U_(0x800003FF) /**< \brief (MTB_MASTER) MASK Register */
...
#define MTB_FLOW_RESETVALUE                                                    \
  _U_(0x00000000) /**< \brief (MTB_FLOW reset_value) MTB Flow */
...
#define MTB_FLOW_WATERMARK(value)                                              \
  (MTB_FLOW_WATERMARK_Msk & ((value) << MTB_FLOW_WATERMARK_Pos))
...
/* -------- MTB_ITCTRL : (MTB Offset: 0xF00) (R/W 32) MTB Integration Mode
 * Control -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  uint32_t reg; /*!< Type      used for register access              */
...
#define MTB_ITCTRL_OFFSET                                                      \
  0xF00 /**< \brief (MTB_ITCTRL offset) MTB Integration Mode Control */
#define MTB_ITCTRL_MASK                                                        \
  _U_(0xFFFFFFFF) /**< \brief (MTB_ITCTRL) MASK Register */
...
#define MTB_CLAIMSET_OFFSET                                                    \
  0xFA0 /**< \brief (MTB_CLAIMSET offset) MTB Claim Set */
#define MTB_CLAIMSET_MASK                                                      \
  _U_(0xFFFFFFFF) /**< \brief (MTB_CLAIMSET) MASK Register */
...
#define MTB_CLAIMCLR_OFFSET                                                    \
  0xFA4 /**< \brief (MTB_CLAIMCLR offset) MTB Claim Clear */
#define MTB_CLAIMCLR_MASK                                                      \
  _U_(0xFFFFFFFF) /**< \brief (MTB_CLAIMCLR) MASK Register */
...
#define MTB_LOCKACCESS_OFFSET                                                  \
  0xFB0 /**< \brief (MTB_LOCKACCESS offset) MTB Lock Access */
#define MTB_LOCKACCESS_MASK                                                    \
  _U_(0xFFFFFFFF) /**< \brief (MTB_LOCKACCESS) MASK Register */
...
#define MTB_LOCKSTATUS_OFFSET                                                  \
  0xFB4 /**< \brief (MTB_LOCKSTATUS offset) MTB Lock Status */
#define MTB_LOCKSTATUS_MASK                                                    \
  _U_(0xFFFFFFFF) /**< \brief (MTB_LOCKSTATUS) MASK Register */

/* -------- MTB_AUTHSTATUS : (MTB Offset: 0xFB8) (R/  32) MTB Authentication
 * Status -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  uint32_t reg; /*!< Type      used for register access              */
...
#define MTB_AUTHSTATUS_OFFSET                                                  \
  0xFB8 /**< \brief (MTB_AUTHSTATUS offset) MTB Authentication Status */
#define MTB_AUTHSTATUS_MASK                                                    \
  _U_(0xFFFFFFFF) /**< \brief (MTB_AUTHSTATUS) MASK Register */
...
#define MTB_DEVARCH_OFFSET                                                     \
  0xFBC /**< \brief (MTB_DEVARCH offset) MTB Device Architecture */
#define MTB_DEVARCH_MASK                                                       \
  _U_(0xFFFFFFFF) /**< \brief (MTB_DEVARCH) MASK Register */
...
#define MTB_DEVID_OFFSET                                                       \
  0xFC8 /**< \brief (MTB_DEVID offset) MTB Device Configuration */
#define MTB_DEVID_MASK                                                         \
  _U_(0xFFFFFFFF) /**< \brief (MTB_DEVID) MASK Register                        \
                   */
...
#define MTB_DEVTYPE_OFFSET                                                     \
  0xFCC /**< \brief (MTB_DEVTYPE offset) MTB Device Type */
#define MTB_DEVTYPE_MASK                                                       \
  _U_(0xFFFFFFFF) /**< \brief (MTB_DEVTYPE) MASK Register */
...
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef struct {
  __IO MTB_POSITION_Type
      POSITION; /**< \brief Offset: 0x000 (R/W 32) MTB Position */
  ...
  __IO MTB_ITCTRL_Type
      ITCTRL; /**< \brief Offset: 0xF00 (R/W 32) MTB Integration Mode Control */
  RoReg8 Reserved2[0x9C];
  __IO MTB_CLAIMSET_Type
      CLAIMSET; /**< \brief Offset: 0xFA0 (R/W 32) MTB Claim Set */
  __IO MTB_CLAIMCLR_Type
      CLAIMCLR; /**< \brief Offset: 0xFA4 (R/W 32) MTB Claim Clear */
  RoReg8 Reserved3[0x8];
  __IO MTB_LOCKACCESS_Type
      LOCKACCESS; /**< \brief Offset: 0xFB0 (R/W 32) MTB Lock Access */
  __I MTB_LOCKSTATUS_Type
      LOCKSTATUS; /**< \brief Offset: 0xFB4 (R/  32) MTB Lock Status */
  __I MTB_AUTHSTATUS_Type AUTHSTATUS; /**< \brief Offset: 0xFB8 (R/  32) MTB
                                         Authentication Status */
  __I MTB_DEVARCH_Type
      DEVARCH; /**< \brief Offset: 0xFBC (R/  32) MTB Device Architecture */
  RoReg8 Reserved4[0x8];
  __I MTB_DEVID_Type
      DEVID; /**< \brief Offset: 0xFC8 (R/  32) MTB Device Configuration */
  __I MTB_DEVTYPE_Type
      DEVTYPE;            /**< \brief Offset: 0xFCC (R/  32) MTB Device Type */
