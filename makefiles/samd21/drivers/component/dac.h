...
#define DAC_CTRLA_RESETVALUE                                                   \
  _U_(0x00) /**< \brief (DAC_CTRLA reset_value) Control A */
...
#define DAC_CTRLB_RESETVALUE                                                   \
  _U_(0x00) /**< \brief (DAC_CTRLB reset_value) Control B */
...
#define DAC_CTRLB_BDWP_Pos                                                     \
  4 /**< \brief (DAC_CTRLB) Bypass DATABUF Write Protection */
...
#define DAC_CTRLB_REFSEL(value)                                                \
  (DAC_CTRLB_REFSEL_Msk & ((value) << DAC_CTRLB_REFSEL_Pos))
#define DAC_CTRLB_REFSEL_INT1V_Val                                             \
  _U_(0x0) /**< \brief (DAC_CTRLB) Internal 1.0V reference */
#define DAC_CTRLB_REFSEL_AVCC_Val _U_(0x1) /**< \brief (DAC_CTRLB) AVCC */
#define DAC_CTRLB_REFSEL_VREFP_Val                                             \
  _U_(0x2) /**< \brief (DAC_CTRLB) External reference */
#define DAC_CTRLB_REFSEL_INT1V                                                 \
  (DAC_CTRLB_REFSEL_INT1V_Val << DAC_CTRLB_REFSEL_Pos)
#define DAC_CTRLB_REFSEL_AVCC                                                  \
  (DAC_CTRLB_REFSEL_AVCC_Val << DAC_CTRLB_REFSEL_Pos)
#define DAC_CTRLB_REFSEL_VREFP                                                 \
  (DAC_CTRLB_REFSEL_VREFP_Val << DAC_CTRLB_REFSEL_Pos)
...
#define DAC_EVCTRL_RESETVALUE                                                  \
  _U_(0x00) /**< \brief (DAC_EVCTRL reset_value) Event Control */

#define DAC_EVCTRL_STARTEI_Pos                                                 \
  0 /**< \brief (DAC_EVCTRL) Start Conversion Event Input */
#define DAC_EVCTRL_STARTEI (_U_(0x1) << DAC_EVCTRL_STARTEI_Pos)
#define DAC_EVCTRL_EMPTYEO_Pos                                                 \
  1 /**< \brief (DAC_EVCTRL) Data Buffer Empty Event Output */
...
typedef union {
  struct {
    ...
    uint8_t SYNCRDY
        : 1;     /*!< bit:      2  Synchronization Ready Interrupt Enable */
    uint8_t : 5; /*!< bit:  3.. 7  Reserved                           */
  } bit;         /*!< Structure used for bit  access                  */
  uint8_t reg;   /*!< Type      used for register access              */
} DAC_INTENCLR_Type;
...
#define DAC_INTENCLR_OFFSET                                                    \
  0x4 /**< \brief (DAC_INTENCLR offset) Interrupt Enable Clear */
#define DAC_INTENCLR_RESETVALUE                                                \
  _U_(0x00) /**< \brief (DAC_INTENCLR reset_value) Interrupt Enable Clear */

#define DAC_INTENCLR_UNDERRUN_Pos                                              \
  0 /**< \brief (DAC_INTENCLR) Underrun Interrupt Enable */
#define DAC_INTENCLR_UNDERRUN (_U_(0x1) << DAC_INTENCLR_UNDERRUN_Pos)
#define DAC_INTENCLR_EMPTY_Pos                                                 \
  1 /**< \brief (DAC_INTENCLR) Data Buffer Empty Interrupt Enable */
#define DAC_INTENCLR_EMPTY (_U_(0x1) << DAC_INTENCLR_EMPTY_Pos)
#define DAC_INTENCLR_SYNCRDY_Pos                                               \
  2 /**< \brief (DAC_INTENCLR) Synchronization Ready Interrupt Enable */
...
#define DAC_INTENSET_OFFSET                                                    \
  0x5 /**< \brief (DAC_INTENSET offset) Interrupt Enable Set */
#define DAC_INTENSET_RESETVALUE                                                \
  _U_(0x00) /**< \brief (DAC_INTENSET reset_value) Interrupt Enable Set */

#define DAC_INTENSET_UNDERRUN_Pos                                              \
  0 /**< \brief (DAC_INTENSET) Underrun Interrupt Enable */
#define DAC_INTENSET_UNDERRUN (_U_(0x1) << DAC_INTENSET_UNDERRUN_Pos)
#define DAC_INTENSET_EMPTY_Pos                                                 \
  1 /**< \brief (DAC_INTENSET) Data Buffer Empty Interrupt Enable */
#define DAC_INTENSET_EMPTY (_U_(0x1) << DAC_INTENSET_EMPTY_Pos)
#define DAC_INTENSET_SYNCRDY_Pos                                               \
  2 /**< \brief (DAC_INTENSET) Synchronization Ready Interrupt Enable */
#define DAC_INTENSET_SYNCRDY (_U_(0x1) << DAC_INTENSET_SYNCRDY_Pos)
#define DAC_INTENSET_MASK                                                      \
  _U_(0x07) /**< \brief (DAC_INTENSET) MASK Register                           \
             */

/* -------- DAC_INTFLAG : (DAC Offset: 0x6) (R/W  8) Interrupt Flag Status and
 * Clear -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
...
#define DAC_INTFLAG_OFFSET                                                     \
  0x6 /**< \brief (DAC_INTFLAG offset) Interrupt Flag Status and Clear */
#define DAC_INTFLAG_RESETVALUE                                                 \
  _U_(0x00) /**< \brief (DAC_INTFLAG reset_value) Interrupt Flag Status and    \
               Clear */
...
#define DAC_INTFLAG_SYNCRDY_Pos                                                \
  2 /**< \brief (DAC_INTFLAG) Synchronization Ready */
...
#define DAC_STATUS_RESETVALUE                                                  \
  _U_(0x00) /**< \brief (DAC_STATUS reset_value) Status */

#define DAC_STATUS_SYNCBUSY_Pos                                                \
  7 /**< \brief (DAC_STATUS) Synchronization Busy Status */
...
#define DAC_DATA_RESETVALUE                                                    \
  _U_(0x0000) /**< \brief (DAC_DATA reset_value) Data */

#define DAC_DATA_DATA_Pos                                                      \
  0 /**< \brief (DAC_DATA) Data value to be converted                          \
     */
#define DAC_DATA_DATA_Msk (_U_(0xFFFF) << DAC_DATA_DATA_Pos)
#define DAC_DATA_DATA(value)                                                   \
  (DAC_DATA_DATA_Msk & ((value) << DAC_DATA_DATA_Pos))
...
#define DAC_DATABUF_RESETVALUE                                                 \
  _U_(0x0000) /**< \brief (DAC_DATABUF reset_value) Data Buffer */
...
#define DAC_DATABUF_DATABUF(value)                                             \
  (DAC_DATABUF_DATABUF_Msk & ((value) << DAC_DATABUF_DATABUF_Pos))
#define DAC_DATABUF_MASK                                                       \
  _U_(0xFFFF) /**< \brief (DAC_DATABUF) MASK Register                          \
               */
...
typedef struct {
  ...
  __IO DAC_INTENCLR_Type
      INTENCLR; /**< \brief Offset: 0x4 (R/W  8) Interrupt Enable Clear */
  __IO DAC_INTENSET_Type
      INTENSET; /**< \brief Offset: 0x5 (R/W  8) Interrupt Enable Set */
  __IO DAC_INTFLAG_Type INTFLAG; /**< \brief Offset: 0x6 (R/W  8) Interrupt Flag
                                    Status and Clear */
